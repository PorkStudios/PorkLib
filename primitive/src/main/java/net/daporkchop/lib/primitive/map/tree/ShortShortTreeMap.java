...
/**
 * A tree map, using a key type of short and a value type of short.
 ...
 * Although this map WORKS, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.ShortShortIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class ShortShortTreeMap implements ShortShortMap    {
    ...
    public short get(short key)    {
        ...
        if (!containsKeyHash(hash)) return (short) 0; //no mapping
    ...
    @SuppressWarnings("unchecked")
    protected short remove(short key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return (short) 0; //no mapping
    ...
    public ShortIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.ShortShortIndexedTreeMap} for an implementation of this method
        return null;
    }
