...
import net.daporkchop.lib.primitive.map.tree.IntegerDoubleTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of double.
 ...
 * @author DaPorkchop_
 */
public class IntegerDoubleIndexedTreeMap extends IntegerDoubleTreeMap    {
    protected boolean[] index;

    public IntegerDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerDoubleIndexedTreeMap this_ = IntegerDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerDoubleIterator   {
        ...
        public IntegerDoubleTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerDoubleImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
