...
public class RC2Test extends SymmetricCipherTest<RC2Key, RC2Helper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.RC2;
    }

    @Override
    public RC2Helper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, RC2Key key) {
        return new RC2Helper(mode, scheme, key);
    }

    @Override
    public RC2Key genKeys() {
        return RC2KeyGen.gen();
    }
}
