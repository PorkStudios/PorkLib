...
import net.daporkchop.lib.primitive.map.tree.DoubleIntegerTreeMap;
...
/**
 * A tree map, using a key type of double and a value type of int.
 ...
 * @author DaPorkchop_
 */
public class DoubleIntegerIndexedTreeMap extends DoubleIntegerTreeMap    {
    protected boolean[] index;

    public DoubleIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleIntegerIndexedTreeMap this_ = DoubleIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleIntegerIterator   {
        ...
        public DoubleIntegerTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleIntegerImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
