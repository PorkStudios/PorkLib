...
import net.daporkchop.lib.primitive.lambda.function.ObjectToByteFunction;
...
/**
 * A map, using a key type of K and a value type of byte.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ObjectByteMap<K extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull K[] keys, @NonNull byte[] values)    {
     ...
     */
    default void putAll(@NonNull ObjectByteMap<K> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ObjectByteConsumer<K> consumer);
     ...
     */
    ObjectByteIterator entryIterator();
     ...
     */
    default byte getOrDefault(K key, byte def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default byte computeIfAbsent(K key, @NonNull ObjectToByteFunction<K> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
