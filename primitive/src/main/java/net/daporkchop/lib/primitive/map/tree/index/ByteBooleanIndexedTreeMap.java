...
import net.daporkchop.lib.primitive.map.tree.ByteBooleanTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ByteBooleanIndexedTreeMap extends ByteBooleanTreeMap    {
    protected boolean[] index;

    public ByteBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteBooleanIndexedTreeMap this_ = ByteBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteBooleanIterator   {
        ...
        public ByteBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
