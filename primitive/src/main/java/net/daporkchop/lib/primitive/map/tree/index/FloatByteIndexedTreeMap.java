...
import net.daporkchop.lib.primitive.map.tree.FloatByteTreeMap;
...
/**
 * A tree map, using a key type of float and a value type of byte.
 ...
 * @author DaPorkchop_
 */
public class FloatByteIndexedTreeMap extends FloatByteTreeMap    {
    protected boolean[] index;

    public FloatByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatByteIndexedTreeMap this_ = FloatByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatByteIterator   {
        ...
        public FloatByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
