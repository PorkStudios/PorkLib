...
import net.daporkchop.lib.primitive.map.tree.CharacterLongTreeMap;
 ...
 * @author DaPorkchop_
 */
public class CharacterLongIndexedTreeMap extends CharacterLongTreeMap    {
    protected boolean[] index;

    public CharacterLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterLongIndexedTreeMap this_ = CharacterLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterLongIterator   {
        ...
        public CharacterLongTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterLongImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
