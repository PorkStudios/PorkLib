...
import net.daporkchop.lib.primitive.lambda.function.ShortToDoubleFunction;
...
/**
 * A map, using a key type of short and a value type of double.
 * <p>
...
public interface ShortDoubleMap   {
     ...
     */
    default void putAll(@NonNull short[] keys, @NonNull double[] values)    {
     ...
     */
    default void putAll(@NonNull ShortDoubleMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ShortDoubleConsumer consumer);
     ...
     */
    ShortDoubleIterator entryIterator();
     ...
     */
    default double getOrDefault(short key, double def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default double computeIfAbsent(short key, @NonNull ShortToDoubleFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
