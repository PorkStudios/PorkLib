...
/**
 * A concurrent iterator over an array of double.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class DoubleConcurrentArrayIterator implements DoubleConcurrentIterator  {
    private final double[] arr;
    private final AtomicInteger index = new AtomicInteger(0);
    private final ThreadLocal<AtomicInteger> tlIndex = ThreadLocal.withInitial(() -> new AtomicInteger(-1));

    public DoubleConcurrentArrayIterator(@NonNull double[] arr)    {
        this.arr = arr;
    }
