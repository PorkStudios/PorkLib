...
@Getter
public class BiggerARGBSampleModel extends SinglePixelPackedSampleModel {
    protected final ImageARGB image;

    public BiggerARGBSampleModel(int dataType, int w, int h, int[] bitMasks, @NonNull ImageARGB image) {
