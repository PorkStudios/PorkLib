...
/**
 * A synchronized map, using a key type of boolean and a value type of float.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of BooleanFloatMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class BooleanFloatSynchronizedMap implements BooleanFloatMap    {
    private final Object sync;
    private final BooleanFloatMap map;

    public BooleanFloatSynchronizedMap(BooleanFloatMap map)    {
        this(map, map);
    }

    public BooleanFloatSynchronizedMap(@NonNull BooleanFloatMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
