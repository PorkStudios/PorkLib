...
import net.daporkchop.lib.primitive.lambda.function.ByteToBooleanFunction;
...
/**
 * A map, using a key type of byte and a value type of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ByteBooleanMap   {
    /**
     ...
     */
    default void putAll(@NonNull byte[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull ByteBooleanMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ByteBooleanConsumer consumer);
     ...
     */
    ByteBooleanIterator entryIterator();
     ...
     */
    default boolean getOrDefault(byte key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(byte key, @NonNull ByteToBooleanFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
