...
import net.daporkchop.lib.primitive.iterator.BooleanIterator;
import net.daporkchop.lib.primitive.iterator.bi.BooleanBooleanIterator;
...
/**
 * A hash map, using a key type of boolean and a value type of boolean.
 ...
 * @author DaPorkchop_
 */
public class BooleanBooleanHashMap implements BooleanBooleanMap    {
    ...
    public BooleanBooleanHashMap()    {
        this(16384);
    }

    public BooleanBooleanHashMap(int baseSize)    {
        this(baseSize, null);
    }

    public BooleanBooleanHashMap(BooleanToIntegerFunction keyHash) {
        this(16384, keyHash);
    }

    public BooleanBooleanHashMap(int baseSize, BooleanToIntegerFunction keyHash)    {
    ...
    @Override
    public void forEachEntry(@NonNull BooleanBooleanConsumer consumer)   {
    ...
    public BooleanBooleanIterator entryIterator() {
    ...
    protected boolean reHash(boolean[] values, boolean[] keys, BitSet states)    {
        return this.forEachBreaking(i -> {
    ...
    private class KeyIterator implements BooleanIterator {
        ...
        public KeyIterator()    {
            this.size = BooleanBooleanHashMap.this.size;
            this.next = BooleanBooleanHashMap.this.states.nextSetBit(0);
        }
        ...
        @SuppressWarnings("unchecked")
        public boolean get()   {
            return BooleanBooleanHashMap.this.keys[this.index];
        }
        ...
        protected void findNext()   {
            this.next = BooleanBooleanHashMap.this.states.nextSetBit((this.index = this.next) + 1);
        }

        @Override
        public void remove()    {
            BooleanBooleanHashMap.this.removeIndex(this.index);
            this.size--;
        }
    }
    ...
    private class ValueIterator implements BooleanIterator {
        ...
        @SuppressWarnings("unchecked")
        public boolean get()   {
            return BooleanBooleanHashMap.this.values[this.index];
        }
    ...
    private class EntryIterator implements BooleanBooleanIterator {
        private int size;
        private int index = -1;
        private int next;
        private BooleanBooleanTuple tuple;
        ...
        @Override
        public BooleanBooleanTuple advance()   {
            findNext();
            if (this.index == -1) throw new IllegalStateException("Reached end of array");
            return this.tuple = new BooleanBooleanImmutableTuple( BooleanBooleanHashMap.this.keys[this.index],  BooleanBooleanHashMap.this.values[this.index]);
        }
