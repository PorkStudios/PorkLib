...
/**
 * A synchronized map, using a key type of short and a value type of int.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ShortIntegerMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ShortIntegerSynchronizedMap implements ShortIntegerMap    {
    private final Object sync;
    private final ShortIntegerMap map;

    public ShortIntegerSynchronizedMap(ShortIntegerMap map)    {
        this(map, map);
    }

    public ShortIntegerSynchronizedMap(@NonNull ShortIntegerMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
