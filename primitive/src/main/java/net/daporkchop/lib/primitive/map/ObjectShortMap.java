...
import net.daporkchop.lib.primitive.lambda.function.ObjectToShortFunction;
...
/**
 * A map, using a key type of K and a value type of short.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ObjectShortMap<K extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull K[] keys, @NonNull short[] values)    {
     ...
     */
    default void putAll(@NonNull ObjectShortMap<K> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ObjectShortConsumer<K> consumer);
     ...
     */
    ObjectShortIterator entryIterator();
     ...
     */
    default short getOrDefault(K key, short def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default short computeIfAbsent(K key, @NonNull ObjectToShortFunction<K> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
