...
/**
 * A synchronized map, using a key type of char and a value type of boolean.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of CharacterBooleanMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class CharacterBooleanSynchronizedMap implements CharacterBooleanMap    {
    private final Object sync;
    private final CharacterBooleanMap map;

    public CharacterBooleanSynchronizedMap(CharacterBooleanMap map)    {
        this(map, map);
    }

    public CharacterBooleanSynchronizedMap(@NonNull CharacterBooleanMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
