...
import net.daporkchop.lib.primitive.map.tree.DoubleShortTreeMap;
 ...
 * @author DaPorkchop_
 */
public class DoubleShortIndexedTreeMap extends DoubleShortTreeMap    {
    protected boolean[] index;

    public DoubleShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleShortIndexedTreeMap this_ = DoubleShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleShortIterator   {
        ...
        public DoubleShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
