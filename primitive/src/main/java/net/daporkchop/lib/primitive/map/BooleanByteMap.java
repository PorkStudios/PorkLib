...
import net.daporkchop.lib.primitive.lambda.function.BooleanToByteFunction;
...
/**
 * A map, using a key type of boolean and a value type of byte.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanByteMap   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull byte[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanByteMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanByteConsumer consumer);
     ...
     */
    BooleanByteIterator entryIterator();
     ...
     */
    default byte putIfAbsent(boolean key, byte value)  {
     ...
     */
    default byte getOrDefault(boolean key, byte def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default byte computeIfAbsent(boolean key, @NonNull BooleanToByteFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
