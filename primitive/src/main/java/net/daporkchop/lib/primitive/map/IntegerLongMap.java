...
/**
 * A map, using a key type of int and a value type of long.
 * <p>
...
public interface IntegerLongMap   {
     ...
     */
    default void putAll(@NonNull int[] keys, @NonNull long[] values)    {
     ...
     */
    default void putAll(@NonNull IntegerLongMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(IntegerLongConsumer consumer);
     ...
     */
    IntegerLongIterator entryIterator();
     ...
     */
    default long computeIfAbsent(int key, @NonNull IntegerToLongFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
