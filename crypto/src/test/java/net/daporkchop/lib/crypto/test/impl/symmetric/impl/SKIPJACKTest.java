...
public class SKIPJACKTest extends SymmetricCipherTest<SKIPJACKKey, SKIPJACKHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.SKIPJACK;
    }
    ...
    @Override
    public SKIPJACKKey genKeys() {
        return SKIPJACKKeyGen.gen();
    }
}
