...
import net.daporkchop.lib.primitive.map.tree.FloatIntegerTreeMap;
 ...
 * @author DaPorkchop_
 */
public class FloatIntegerIndexedTreeMap extends FloatIntegerTreeMap    {
    protected boolean[] index;

    public FloatIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatIntegerIndexedTreeMap this_ = FloatIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatIntegerIterator   {
        ...
        public FloatIntegerTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatIntegerImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
