...
/**
 * A concurrent iterator over an array of K.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ObjectConcurrentArrayIterator<K extends Object> implements ObjectConcurrentIterator<K>  {
    private final K[] arr;
    private final AtomicInteger index = new AtomicInteger(0);
    private final ThreadLocal<AtomicInteger> tlIndex = ThreadLocal.withInitial(() -> new AtomicInteger(-1));

    public ObjectConcurrentArrayIterator(@NonNull K[] arr)    {
        this.arr = arr;
    }
