...
import net.daporkchop.lib.primitive.map.tree.ShortCharacterTreeMap;
...
/**
 * A tree map, using a key type of short and a value type of char.
 ...
 * @author DaPorkchop_
 */
public class ShortCharacterIndexedTreeMap extends ShortCharacterTreeMap    {
    protected boolean[] index;

    public ShortCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortCharacterIndexedTreeMap this_ = ShortCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortCharacterIterator   {
        ...
        public ShortCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
