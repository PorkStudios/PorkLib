...
import net.daporkchop.lib.primitive.lambda.function.ObjectToFloatFunction;
...
/**
 * A map, using a key type of K and a value type of float.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ObjectFloatMap<K extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull K[] keys, @NonNull float[] values)    {
     ...
     */
    default void putAll(@NonNull ObjectFloatMap<K> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ObjectFloatConsumer<K> consumer);
     ...
     */
    ObjectFloatIterator entryIterator();
     ...
     */
    default float getOrDefault(K key, float def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default float computeIfAbsent(K key, @NonNull ObjectToFloatFunction<K> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
