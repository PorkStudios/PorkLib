...
/**
 * A synchronized map, using a key type of long and a value type of V.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of LongObjectMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class LongObjectSynchronizedMap<V extends Object> implements LongObjectMap<V>    {
    private final Object sync;
    private final LongObjectMap<V> map;

    public LongObjectSynchronizedMap(LongObjectMap<V> map)    {
        this(map, map);
    }

    public LongObjectSynchronizedMap(@NonNull LongObjectMap<V> map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
