...
import net.daporkchop.lib.primitive.map.tree.LongObjectTreeMap;
 ...
 * @author DaPorkchop_
 */
public class LongObjectIndexedTreeMap<V extends Object> extends LongObjectTreeMap<V>    {
    protected boolean[] index;

    public LongObjectIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongObjectIndexedTreeMap this_ = LongObjectIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongObjectIterator<V>   {
        ...
        public LongObjectTuple<V> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongObjectImmutableTuple<V>( this_.keys[this.index],  (V) this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
