...
import net.daporkchop.lib.primitive.map.tree.FloatObjectTreeMap;
...
/**
 * A tree map, using a key type of float and a value type of V.
 ...
 * @author DaPorkchop_
 */
public class FloatObjectIndexedTreeMap<V extends Object> extends FloatObjectTreeMap<V>    {
    protected boolean[] index;

    public FloatObjectIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatObjectIndexedTreeMap this_ = FloatObjectIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatObjectIterator<V>   {
        ...
        public FloatObjectTuple<V> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatObjectImmutableTuple<V>( this_.keys[this.index],  (V) this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
