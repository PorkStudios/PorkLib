...
import net.daporkchop.lib.primitive.lambda.function.CharacterToFloatFunction;
...
/**
 * A map, using a key type of char and a value type of float.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface CharacterFloatMap   {
    /**
     ...
     */
    default void putAll(@NonNull char[] keys, @NonNull float[] values)    {
     ...
     */
    default void putAll(@NonNull CharacterFloatMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(CharacterFloatConsumer consumer);
     ...
     */
    CharacterFloatIterator entryIterator();
     ...
     */
    default float getOrDefault(char key, float def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default float computeIfAbsent(char key, @NonNull CharacterToFloatFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
