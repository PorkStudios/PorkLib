...
import net.daporkchop.lib.primitive.lambda.function.bi.ShortBooleanToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of short => boolean mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface ShortBooleanConcurrentIterator extends ShortBooleanIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ShortBooleanToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                ShortBooleanTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<ShortBooleanTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<ShortBooleanTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ShortBooleanConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<ShortBooleanTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull ShortBooleanToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
