...
/**
 * A synchronized map, using a key type of boolean and a value type of byte.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of BooleanByteMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class BooleanByteSynchronizedMap implements BooleanByteMap    {
    private final Object sync;
    private final BooleanByteMap map;

    public BooleanByteSynchronizedMap(BooleanByteMap map)    {
        this(map, map);
    }

    public BooleanByteSynchronizedMap(@NonNull BooleanByteMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
