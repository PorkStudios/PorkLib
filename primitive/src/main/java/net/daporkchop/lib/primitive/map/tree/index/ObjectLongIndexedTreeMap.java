...
import net.daporkchop.lib.primitive.map.tree.ObjectLongTreeMap;
...
/**
 * A tree map, using a key type of K and a value type of long.
 ...
 * @author DaPorkchop_
 */
public class ObjectLongIndexedTreeMap<K extends Object> extends ObjectLongTreeMap<K>    {
    protected boolean[] index;

    public ObjectLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ObjectIterator<K>   {
        ...
        private final ObjectLongIndexedTreeMap this_ = ObjectLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements ObjectLongIterator<K>   {
        ...
        public ObjectLongTuple<K> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ObjectLongImmutableTuple<K>( (K) this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
