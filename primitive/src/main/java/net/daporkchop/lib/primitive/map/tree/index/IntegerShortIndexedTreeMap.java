...
import net.daporkchop.lib.primitive.map.tree.IntegerShortTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of short.
 ...
 * @author DaPorkchop_
 */
public class IntegerShortIndexedTreeMap extends IntegerShortTreeMap    {
    protected boolean[] index;

    public IntegerShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerShortIndexedTreeMap this_ = IntegerShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerShortIterator   {
        ...
        public IntegerShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
