...
public class ARIAHelper extends BlockCipherHelper<ARIAKey> {
    public ARIAHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull ARIAKey key) {
        this(mode, scheme, key, UpdaterMode.HASH_SHA_256);
    }

    public ARIAHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull ARIAKey key, @NonNull UpdaterMode updater) {
