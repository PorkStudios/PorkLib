...
/**
 * A tree map, using a key type of boolean and a value type of short.
 ...
 * Although this map WORKS, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.BooleanShortIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class BooleanShortTreeMap implements BooleanShortMap    {
    ...
    @SuppressWarnings("unchecked")
    protected short remove(boolean key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return (short) 0; //no mapping
    ...
    public BooleanIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.BooleanShortIndexedTreeMap} for an implementation of this method
        return null;
    }
