...
/**
 * A synchronized map, using a key type of int and a value type of long.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of IntegerLongMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class IntegerLongSynchronizedMap implements IntegerLongMap    {
    private final Object sync;
    private final IntegerLongMap map;

    public IntegerLongSynchronizedMap(IntegerLongMap map)    {
        this(map, map);
    }

    public IntegerLongSynchronizedMap(@NonNull IntegerLongMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
