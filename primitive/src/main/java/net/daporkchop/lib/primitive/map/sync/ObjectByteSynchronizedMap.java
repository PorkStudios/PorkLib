...
/**
 * A synchronized map, using a key type of K and a value type of byte.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ObjectByteMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ObjectByteSynchronizedMap<K extends Object> implements ObjectByteMap<K>    {
    private final Object sync;
    private final ObjectByteMap<K> map;

    public ObjectByteSynchronizedMap(ObjectByteMap<K> map)    {
        this(map, map);
    }

    public ObjectByteSynchronizedMap(@NonNull ObjectByteMap<K> map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
