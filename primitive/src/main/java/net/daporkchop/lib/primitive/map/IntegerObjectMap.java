...
/**
 * A map, using a key type of int and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface IntegerObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull int[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull IntegerObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(IntegerObjectConsumer<V> consumer);
     ...
     */
    IntegerObjectIterator entryIterator();
     ...
     */
    default V computeIfAbsent(int key, @NonNull IntegerToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
