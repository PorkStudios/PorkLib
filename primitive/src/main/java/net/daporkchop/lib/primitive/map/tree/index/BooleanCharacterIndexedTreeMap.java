...
import net.daporkchop.lib.primitive.map.tree.BooleanCharacterTreeMap;
...
/**
 * A tree map, using a key type of boolean and a value type of char.
 ...
 * @author DaPorkchop_
 */
public class BooleanCharacterIndexedTreeMap extends BooleanCharacterTreeMap    {
    protected boolean[] index;

    public BooleanCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanCharacterIndexedTreeMap this_ = BooleanCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanCharacterIterator   {
        ...
        public BooleanCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
