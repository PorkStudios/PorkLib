...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanBooleanToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => boolean mappings. Implementing classes should be
 * thread safe and concurrent (calling advance() should throw {@link IteratorCompleteException} instead of false,
 ...
 * @author DaPorkchop_
 */
public interface BooleanBooleanConcurrentIterator extends BooleanBooleanIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanBooleanToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                BooleanBooleanTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanBooleanTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanBooleanTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanBooleanConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanBooleanTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanBooleanToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
