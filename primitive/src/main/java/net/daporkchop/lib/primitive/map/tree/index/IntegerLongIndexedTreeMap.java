...
import net.daporkchop.lib.primitive.map.tree.IntegerLongTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of long.
 ...
 * @author DaPorkchop_
 */
public class IntegerLongIndexedTreeMap extends IntegerLongTreeMap    {
    protected boolean[] index;

    public IntegerLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerLongIndexedTreeMap this_ = IntegerLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerLongIterator   {
        ...
        public IntegerLongTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerLongImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
