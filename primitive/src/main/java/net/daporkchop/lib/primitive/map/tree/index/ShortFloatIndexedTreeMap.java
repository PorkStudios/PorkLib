...
import net.daporkchop.lib.primitive.map.tree.ShortFloatTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ShortFloatIndexedTreeMap extends ShortFloatTreeMap    {
    protected boolean[] index;

    public ShortFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortFloatIndexedTreeMap this_ = ShortFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortFloatIterator   {
        ...
        public ShortFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
