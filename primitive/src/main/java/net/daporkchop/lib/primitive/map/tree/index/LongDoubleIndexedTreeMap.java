...
import net.daporkchop.lib.primitive.map.tree.LongDoubleTreeMap;
...
/**
 * A tree map, using a key type of long and a value type of double.
 ...
 * @author DaPorkchop_
 */
public class LongDoubleIndexedTreeMap extends LongDoubleTreeMap    {
    protected boolean[] index;

    public LongDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongDoubleIndexedTreeMap this_ = LongDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongDoubleIterator   {
        ...
        public LongDoubleTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongDoubleImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
