...
import net.daporkchop.lib.primitive.lambda.function.ByteToCharacterFunction;
...
/**
 * A map, using a key type of byte and a value type of char.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ByteCharacterMap   {
    /**
     ...
     */
    default void putAll(@NonNull byte[] keys, @NonNull char[] values)    {
     ...
     */
    default void putAll(@NonNull ByteCharacterMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ByteCharacterConsumer consumer);
     ...
     */
    ByteCharacterIterator entryIterator();
     ...
     */
    default char getOrDefault(byte key, char def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default char computeIfAbsent(byte key, @NonNull ByteToCharacterFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
