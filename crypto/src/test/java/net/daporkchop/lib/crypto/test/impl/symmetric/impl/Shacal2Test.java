...
public class Shacal2Test extends SymmetricCipherTest<Shacal2Key, Shacal2Helper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.SHACAL2;
    }
    ...
    @Override
    public Shacal2Key genKeys() {
        return Shacal2KeyGen.gen();
    }
}
