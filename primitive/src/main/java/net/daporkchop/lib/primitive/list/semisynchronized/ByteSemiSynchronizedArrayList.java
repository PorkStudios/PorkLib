 ...
 * @author DaPorkchop_
 */
public class ByteSemiSynchronizedArrayList implements ByteList   {
    private int size = 0, len;

    private byte[] backing;

    public ByteSemiSynchronizedArrayList()  {
        this.clear();
    }
    ...
    private class Iterator implements ByteIterator  {
        private final ByteSemiSynchronizedArrayList this_ = ByteSemiSynchronizedArrayList.this;
        private int index;
