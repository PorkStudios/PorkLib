...
import net.daporkchop.lib.primitive.map.tree.ByteShortTreeMap;
...
/**
 * A tree map, using a key type of byte and a value type of short.
 ...
 * @author DaPorkchop_
 */
public class ByteShortIndexedTreeMap extends ByteShortTreeMap    {
    protected boolean[] index;

    public ByteShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteShortIndexedTreeMap this_ = ByteShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteShortIterator   {
        ...
        public ByteShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
