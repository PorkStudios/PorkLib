...
import net.daporkchop.lib.primitive.map.tree.ObjectBooleanTreeMap;
...
/**
 * A tree map, using a key type of K and a value type of boolean.
 ...
 * @author DaPorkchop_
 */
public class ObjectBooleanIndexedTreeMap<K extends Object> extends ObjectBooleanTreeMap<K>    {
    protected boolean[] index;

    public ObjectBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ObjectIterator<K>   {
        ...
        private final ObjectBooleanIndexedTreeMap this_ = ObjectBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements ObjectBooleanIterator<K>   {
        ...
        public ObjectBooleanTuple<K> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ObjectBooleanImmutableTuple<K>( (K) this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
