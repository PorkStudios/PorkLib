...
public class NoekeonTest extends SymmetricCipherTest<NoekeonKey, NoekeonHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.NOEKEON;
    }

    @Override
    public NoekeonHelper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, NoekeonKey key) {
        return new NoekeonHelper(mode, scheme, key);
    }

    @Override
    public NoekeonKey genKeys() {
        return NoekeonKeyGen.gen();
    }
}
