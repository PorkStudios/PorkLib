...
/**
 * Adaptation of <a href="https://gist.github.com/KdotJPG/b1270127455a94ac5d19">OpenSimplex noise</a> with some slight optimizations.
 *
 * @author DaPorkchop_
 */
public class OpenSimplexNoiseEngine implements NoiseSource {
    ...
    private static final double STRETCH_CONSTANT_3D = -1.0d / 6.0d;
    private static final double SQUISH_CONSTANT_3D  = 1.0d / 3.0d;
