...
/**
 * A map, using a key type of K and a value type of long.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ObjectLongMap<K extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull K[] keys, @NonNull long[] values)    {
     ...
     */
    default void putAll(@NonNull ObjectLongMap<K> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ObjectLongConsumer<K> consumer);
     ...
     */
    ObjectLongIterator entryIterator();
     ...
     */
    default long computeIfAbsent(K key, @NonNull ObjectToLongFunction<K> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
