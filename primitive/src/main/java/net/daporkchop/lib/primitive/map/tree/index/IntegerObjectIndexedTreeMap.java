...
import net.daporkchop.lib.primitive.map.tree.IntegerObjectTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of V.
 ...
 * @author DaPorkchop_
 */
public class IntegerObjectIndexedTreeMap<V extends Object> extends IntegerObjectTreeMap<V>    {
    protected boolean[] index;

    public IntegerObjectIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerObjectIndexedTreeMap this_ = IntegerObjectIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerObjectIterator<V>   {
        ...
        public IntegerObjectTuple<V> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerObjectImmutableTuple<V>( this_.keys[this.index],  (V) this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
