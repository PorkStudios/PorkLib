...
/**
 * A map, using a key type of long and a value type of long.
 * <p>
...
public interface LongLongMap   {
     ...
     */
    default void putAll(@NonNull long[] keys, @NonNull long[] values)    {
     ...
     */
    default void putAll(@NonNull LongLongMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(LongLongConsumer consumer);
     ...
     */
    LongLongIterator entryIterator();
     ...
     */
    default long computeIfAbsent(long key, @NonNull LongToLongFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
