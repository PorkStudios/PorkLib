...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanShortToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => short mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface BooleanShortConcurrentIterator extends BooleanShortIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanShortToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                BooleanShortTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanShortTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanShortTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanShortConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanShortTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanShortToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
