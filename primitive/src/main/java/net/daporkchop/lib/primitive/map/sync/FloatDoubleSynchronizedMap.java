...
/**
 * A synchronized map, using a key type of float and a value type of double.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of FloatDoubleMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class FloatDoubleSynchronizedMap implements FloatDoubleMap    {
    private final Object sync;
    private final FloatDoubleMap map;

    public FloatDoubleSynchronizedMap(FloatDoubleMap map)    {
        this(map, map);
    }

    public FloatDoubleSynchronizedMap(@NonNull FloatDoubleMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
