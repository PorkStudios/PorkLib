...
import net.daporkchop.lib.primitive.map.tree.ObjectIntegerTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ObjectIntegerIndexedTreeMap<K extends Object> extends ObjectIntegerTreeMap<K>    {
    protected boolean[] index;

    public ObjectIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ObjectIterator<K>   {
        ...
        private final ObjectIntegerIndexedTreeMap this_ = ObjectIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements ObjectIntegerIterator<K>   {
        ...
        public ObjectIntegerTuple<K> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ObjectIntegerImmutableTuple<K>( (K) this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
