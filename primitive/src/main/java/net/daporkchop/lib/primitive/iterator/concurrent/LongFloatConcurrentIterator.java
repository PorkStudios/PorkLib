...
/**
 * Allows parallel iteration over an iterator of long => float mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface LongFloatConcurrentIterator extends LongFloatIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull LongFloatToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<LongFloatTuple> function)    {
        try {
            while (this.hasNext())  {
