...
import net.daporkchop.lib.primitive.lambda.function.LongToObjectFunction;
...
/**
 * A map, using a key type of long and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface LongObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull long[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull LongObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(LongObjectConsumer<V> consumer);
     ...
     */
    LongObjectIterator entryIterator();
     ...
     */
    default V computeIfAbsent(long key, @NonNull LongToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
