...
import net.daporkchop.lib.primitive.lambda.function.ShortToObjectFunction;
...
/**
 * A map, using a key type of short and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ShortObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull short[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull ShortObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ShortObjectConsumer<V> consumer);
     ...
     */
    ShortObjectIterator entryIterator();
     ...
     */
    default V getOrDefault(short key, V def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default V computeIfAbsent(short key, @NonNull ShortToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
