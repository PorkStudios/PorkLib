...
import net.daporkchop.lib.primitive.map.tree.ObjectDoubleTreeMap;
...
/**
 * A tree map, using a key type of K and a value type of double.
 ...
 * @author DaPorkchop_
 */
public class ObjectDoubleIndexedTreeMap<K extends Object> extends ObjectDoubleTreeMap<K>    {
    protected boolean[] index;

    public ObjectDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ObjectIterator<K>   {
        ...
        private final ObjectDoubleIndexedTreeMap this_ = ObjectDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements ObjectDoubleIterator<K>   {
        ...
        public ObjectDoubleTuple<K> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ObjectDoubleImmutableTuple<K>( (K) this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
