...
import net.daporkchop.lib.primitive.lambda.function.IntegerToShortFunction;
...
/**
 * A map, using a key type of int and a value type of short.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface IntegerShortMap   {
    /**
     ...
     */
    default void putAll(@NonNull int[] keys, @NonNull short[] values)    {
     ...
     */
    default void putAll(@NonNull IntegerShortMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(IntegerShortConsumer consumer);
     ...
     */
    IntegerShortIterator entryIterator();
     ...
     */
    default short getOrDefault(int key, short def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default short computeIfAbsent(int key, @NonNull IntegerToShortFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
