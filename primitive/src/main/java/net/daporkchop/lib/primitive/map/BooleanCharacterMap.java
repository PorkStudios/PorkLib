...
import net.daporkchop.lib.primitive.lambda.function.BooleanToCharacterFunction;
...
/**
 * A map, using a key type of boolean and a value type of char.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanCharacterMap   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull char[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanCharacterMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanCharacterConsumer consumer);
     ...
     */
    BooleanCharacterIterator entryIterator();
     ...
     */
    default char putIfAbsent(boolean key, char value)  {
     ...
     */
    default char getOrDefault(boolean key, char def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default char computeIfAbsent(boolean key, @NonNull BooleanToCharacterFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
