...
public interface ByteList   {
     ...
     * @return the element at to the given index, or (byte) 0 if no such mapping exists
     */
    byte get(int index);
     ...
     */
    default void addAll(@NonNull byte[] values)    {
        for (byte p : values)   {
            this.add(p);
        }
    }
     ...
     */
    default void addAll(@NonNull ByteList list)    {
     ...
     */
    default void removeAll(@NonNull Collection<Byte> values) {
