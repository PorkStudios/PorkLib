...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanCharacterToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => char mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface BooleanCharacterConcurrentIterator extends BooleanCharacterIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanCharacterToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                BooleanCharacterTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanCharacterTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanCharacterTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanCharacterConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanCharacterTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanCharacterToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
