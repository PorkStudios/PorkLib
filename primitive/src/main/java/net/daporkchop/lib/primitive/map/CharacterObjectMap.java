...
import net.daporkchop.lib.primitive.lambda.function.CharacterToObjectFunction;
...
/**
 * A map, using a key type of char and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface CharacterObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull char[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull CharacterObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(CharacterObjectConsumer<V> consumer);
     ...
     */
    CharacterObjectIterator entryIterator();
     ...
     */
    default V computeIfAbsent(char key, @NonNull CharacterToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
