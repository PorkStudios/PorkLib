...
import net.daporkchop.lib.primitive.map.tree.BooleanShortTreeMap;
 ...
 * @author DaPorkchop_
 */
public class BooleanShortIndexedTreeMap extends BooleanShortTreeMap    {
    protected boolean[] index;

    public BooleanShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanShortIndexedTreeMap this_ = BooleanShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanShortIterator   {
        ...
        public BooleanShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
