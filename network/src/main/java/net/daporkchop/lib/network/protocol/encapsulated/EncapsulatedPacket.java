...
/**
 * Used by all packets in the encapsulated protocol
 *
 * @author DaPorkchop_
 */
public interface EncapsulatedPacket extends Packet {
    @Override
    default void read(DataIn in) {
        throw new UnsupportedOperationException();
    }

    @Override
    default void write(DataOut out) {
        throw new UnsupportedOperationException();
    }
     ...
     */
    void read(DataIn in, PacketProtocol protocol) throws IOException;
     ...
     * @throws IOException if an IO exception happens i guess lol
     */
    void write(DataOut out, PacketProtocol protocol) throws IOException;
