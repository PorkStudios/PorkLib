...
import net.daporkchop.lib.primitive.map.tree.FloatBooleanTreeMap;
 ...
 * @author DaPorkchop_
 */
public class FloatBooleanIndexedTreeMap extends FloatBooleanTreeMap    {
    protected boolean[] index;

    public FloatBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatBooleanIndexedTreeMap this_ = FloatBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatBooleanIterator   {
        ...
        public FloatBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
