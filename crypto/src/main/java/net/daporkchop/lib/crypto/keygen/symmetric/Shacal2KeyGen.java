...
public class Shacal2KeyGen {
    static {
        BouncyCastleInit.loadClass();
    }

    public static Shacal2Key gen(byte[] data) {
        byte[] b = new byte[BlockCipherType.SHACAL2.blockSize];
        int i = 0;
        do {
        ...
        data = b;
        return new Shacal2Key(new SecretKeySpec(data, "aaa"), KeyRandom.getBytes(BlockCipherType.SHACAL2.blockSize));
    }

    public static Shacal2Key gen() {
        byte[] key = new byte[BlockCipherType.SHACAL2.blockSize];
