...
/**
 * A map, using a key type of char and a value type of long.
 * <p>
...
public interface CharacterLongMap   {
     ...
     */
    default void putAll(@NonNull char[] keys, @NonNull long[] values)    {
     ...
     */
    default void putAll(@NonNull CharacterLongMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(CharacterLongConsumer consumer);
     ...
     */
    CharacterLongIterator entryIterator();
     ...
     */
    default long getOrDefault(char key, long def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default long computeIfAbsent(char key, @NonNull CharacterToLongFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
