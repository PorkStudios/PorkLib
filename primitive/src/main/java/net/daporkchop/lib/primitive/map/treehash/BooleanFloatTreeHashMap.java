 ...
 * overhead, and can even be made concurrent with little extra work (see {@link net.daporkchop.lib.primitive.map.concurrent.BooleanFloatConcurrentTreeHashMap})
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class BooleanFloatTreeHashMap implements BooleanFloatMap    {
    ...
    public BooleanFloatTreeHashMap()    {
        this(null, 0);
    }

    public BooleanFloatTreeHashMap(BooleanToLongFunction hashFunc, int hashLen)    {
        ...
        this.rootPointer = this.hashLen == 0 ? new BooleanFloatTreeHashMap.ValueSector(null, -1) : new BooleanFloatTreeHashMap.PointerSector(null, -1);
    }
    ...
    public void forEachKey(@NonNull BooleanConsumer consumer)  {
        ObjectConsumer<Sector> c = sector -> {
                    if (sector instanceof BooleanFloatTreeHashMap.PointerSector)    {
    ...
    private Sector getSectorFor(long hash, boolean create)    {
        ...
        for (int i = 1; i < this.hashLen; i++) {
            ...
            if (next == null)    {
                if (create) {
                    next = i + 1 == this.hashLen ? new BooleanFloatTreeHashMap.ValueSector(curr, off) : new BooleanFloatTreeHashMap.PointerSector(curr, off);
    ...
    private abstract class Sector  {
        ...
        public float setEntry(int index, boolean key, float value)   {
            throw new UnsupportedOperationException();
        }
    ...
    private class ValueSector extends Sector   {
        ...
        public float setEntry(int index, boolean key, float value)   {
            ...
            if (this.states.get(index))    {
                ...
                this.states.set(index);
                this.refs++;
                BooleanFloatTreeHashMap.this.size.incrementAndGet();
                return 0F;
            }
        }
        ...
        public float removeEntry(int index)  {
            if (this.states.get(index)) {
                this.states.clear(index);
                BooleanFloatTreeHashMap.this.size.decrementAndGet();
                if (--this.refs == 0 && this.parent != null)   {
                    this.parent.removeSector(this.parentOffset);
                }
                return this.values[index];
