...
import net.daporkchop.lib.primitive.map.tree.ByteFloatTreeMap;
...
/**
 * A tree map, using a key type of byte and a value type of float.
 ...
 * @author DaPorkchop_
 */
public class ByteFloatIndexedTreeMap extends ByteFloatTreeMap    {
    protected boolean[] index;

    public ByteFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteFloatIndexedTreeMap this_ = ByteFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteFloatIterator   {
        ...
        public ByteFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
