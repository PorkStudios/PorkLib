...
/**
 * A concurrent iterator over an array of byte.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ByteConcurrentArrayIterator implements ByteConcurrentIterator  {
    private final byte[] arr;
    private final AtomicInteger index = new AtomicInteger(0);
    private final ThreadLocal<AtomicInteger> tlIndex = ThreadLocal.withInitial(() -> new AtomicInteger(-1));

    public ByteConcurrentArrayIterator(@NonNull byte[] arr)    {
        this.arr = arr;
    }
