...
public class GOST_3412_2015KeyGen {
    static {
        BouncyCastleInit.loadClass();
    }

    public static GOST_3412_2015Key gen(byte[] data) {
        byte[] b = new byte[32];
        int i = 0;
        do {
        ...
        data = b;
        return new GOST_3412_2015Key(new SecretKeySpec(data, "aaa"), KeyRandom.getBytes(BlockCipherType.GOST_3412_2015.blockSize));
    }

    public static GOST_3412_2015Key gen() {
