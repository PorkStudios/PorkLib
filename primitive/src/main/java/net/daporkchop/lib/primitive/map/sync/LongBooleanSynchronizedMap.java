...
/**
 * A synchronized map, using a key type of long and a value type of boolean.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of LongBooleanMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class LongBooleanSynchronizedMap implements LongBooleanMap    {
    private final Object sync;
    private final LongBooleanMap map;

    public LongBooleanSynchronizedMap(LongBooleanMap map)    {
        this(map, map);
    }

    public LongBooleanSynchronizedMap(@NonNull LongBooleanMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
