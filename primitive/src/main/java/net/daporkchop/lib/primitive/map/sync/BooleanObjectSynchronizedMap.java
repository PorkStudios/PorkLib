...
/**
 * A synchronized map, using a key type of boolean and a value type of V.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of BooleanObjectMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class BooleanObjectSynchronizedMap<V extends Object> implements BooleanObjectMap<V>    {
    private final Object sync;
    private final BooleanObjectMap<V> map;

    public BooleanObjectSynchronizedMap(BooleanObjectMap<V> map)    {
        this(map, map);
    }

    public BooleanObjectSynchronizedMap(@NonNull BooleanObjectMap<V> map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
