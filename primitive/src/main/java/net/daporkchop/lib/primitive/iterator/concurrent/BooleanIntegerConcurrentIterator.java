...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanIntegerToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => int mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface BooleanIntegerConcurrentIterator extends BooleanIntegerIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanIntegerToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                BooleanIntegerTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanIntegerTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanIntegerTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanIntegerConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanIntegerTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanIntegerToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
