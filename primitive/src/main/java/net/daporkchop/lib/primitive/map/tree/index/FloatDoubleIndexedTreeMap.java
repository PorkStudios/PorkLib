...
import net.daporkchop.lib.primitive.map.tree.FloatDoubleTreeMap;
...
/**
 * A tree map, using a key type of float and a value type of double.
 ...
 * @author DaPorkchop_
 */
public class FloatDoubleIndexedTreeMap extends FloatDoubleTreeMap    {
    protected boolean[] index;

    public FloatDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatDoubleIndexedTreeMap this_ = FloatDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatDoubleIterator   {
        ...
        public FloatDoubleTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatDoubleImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
