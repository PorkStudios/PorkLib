...
import net.daporkchop.lib.hash.impl.skid.sha.Sha256Impl;

/**
 * A thread-safe wrapper for the Sha256 hashing algorithm
 *
 * @author DaPorkchop_
 */
public class Sha256Helper {
    private static final Sha256Helper INSTANCE = new Sha256Helper();
    private final ThreadLocal<Sha256Impl> tl = ThreadLocal.withInitial(Sha256Impl::new);
