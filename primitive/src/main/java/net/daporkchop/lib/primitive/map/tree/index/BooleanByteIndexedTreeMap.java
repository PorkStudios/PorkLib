...
import net.daporkchop.lib.primitive.map.tree.BooleanByteTreeMap;
 ...
 * @author DaPorkchop_
 */
public class BooleanByteIndexedTreeMap extends BooleanByteTreeMap    {
    protected boolean[] index;

    public BooleanByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanByteIndexedTreeMap this_ = BooleanByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanByteIterator   {
        ...
        public BooleanByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
