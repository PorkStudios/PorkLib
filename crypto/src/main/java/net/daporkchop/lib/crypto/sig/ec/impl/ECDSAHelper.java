...
import net.daporkchop.lib.crypto.sig.ec.ECAlgorithms;
import net.daporkchop.lib.crypto.sig.ec.hackery.ECSignatureSpi;

public class ECDSAHelper extends AbstractECHelper<ECDSAKeyPair> {
    public ECDSAHelper(HashTypes hash) {
        super(() -> new ECSignatureSpi(hash.getAsDigest(), ECAlgorithms.ECDSA.supplier.get(), PlainDSAEncoder.INSTANCE));
    }
}
