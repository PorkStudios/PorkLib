...
/**
 * A synchronized map, using a key type of short and a value type of V.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ShortObjectMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ShortObjectSynchronizedMap<V extends Object> implements ShortObjectMap<V>    {
    private final Object sync;
    private final ShortObjectMap<V> map;

    public ShortObjectSynchronizedMap(ShortObjectMap<V> map)    {
        this(map, map);
    }

    public ShortObjectSynchronizedMap(@NonNull ShortObjectMap<V> map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
