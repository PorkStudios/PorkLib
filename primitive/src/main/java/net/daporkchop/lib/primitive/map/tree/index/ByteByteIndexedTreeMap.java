...
import net.daporkchop.lib.primitive.map.tree.ByteByteTreeMap;
...
/**
 * A tree map, using a key type of byte and a value type of byte.
 ...
 * @author DaPorkchop_
 */
public class ByteByteIndexedTreeMap extends ByteByteTreeMap    {
    protected boolean[] index;

    public ByteByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteByteIndexedTreeMap this_ = ByteByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteByteIterator   {
        ...
        public ByteByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
