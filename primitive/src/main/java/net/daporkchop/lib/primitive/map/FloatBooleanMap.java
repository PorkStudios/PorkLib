...
import net.daporkchop.lib.primitive.lambda.function.FloatToBooleanFunction;
...
/**
 * A map, using a key type of float and a value type of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface FloatBooleanMap   {
    /**
     ...
     */
    default void putAll(@NonNull float[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull FloatBooleanMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachValue(BooleanConsumer consumer);
     ...
     * @param consumer the function to run
     */
    void forEachEntry(FloatBooleanConsumer consumer);
     ...
     */
    FloatBooleanIterator entryIterator();
     ...
     *
     * @return the previous value (false if not present previously)
     */
     ...
     */
    default boolean getOrDefault(float key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(float key, @NonNull FloatToBooleanFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            boolean val = func.apply(key);
            this.put(key, val);
            return val;
        }
    }
