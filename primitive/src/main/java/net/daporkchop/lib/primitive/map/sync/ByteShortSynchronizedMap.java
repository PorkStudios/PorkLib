...
/**
 * A synchronized map, using a key type of byte and a value type of short.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ByteShortMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ByteShortSynchronizedMap implements ByteShortMap    {
    private final Object sync;
    private final ByteShortMap map;

    public ByteShortSynchronizedMap(ByteShortMap map)    {
        this(map, map);
    }

    public ByteShortSynchronizedMap(@NonNull ByteShortMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
