...
public abstract class DefaultCompletable<I extends Completable<I>> extends DefaultListenable<I> implements Completable<I> {
    ...
    @Override
    @SuppressWarnings("unchecked")
    protected void doFireListener(@NonNull Consumer<I> listener) {
