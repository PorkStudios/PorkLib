...
import net.daporkchop.lib.primitive.map.tree.BooleanLongTreeMap;
 ...
 * @author DaPorkchop_
 */
public class BooleanLongIndexedTreeMap extends BooleanLongTreeMap    {
    protected boolean[] index;

    public BooleanLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanLongIndexedTreeMap this_ = BooleanLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanLongIterator   {
        ...
        public BooleanLongTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanLongImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
