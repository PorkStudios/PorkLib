...
import net.daporkchop.lib.primitive.map.tree.BooleanIntegerTreeMap;
...
/**
 * A tree map, using a key type of boolean and a value type of int.
 ...
 * @author DaPorkchop_
 */
public class BooleanIntegerIndexedTreeMap extends BooleanIntegerTreeMap    {
    protected boolean[] index;

    public BooleanIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanIntegerIndexedTreeMap this_ = BooleanIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanIntegerIterator   {
        ...
        public BooleanIntegerTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanIntegerImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
