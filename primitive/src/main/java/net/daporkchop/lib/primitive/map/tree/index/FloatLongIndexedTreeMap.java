...
import net.daporkchop.lib.primitive.map.tree.FloatLongTreeMap;
 ...
 * @author DaPorkchop_
 */
public class FloatLongIndexedTreeMap extends FloatLongTreeMap    {
    protected boolean[] index;

    public FloatLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatLongIndexedTreeMap this_ = FloatLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatLongIterator   {
        ...
        public FloatLongTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatLongImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
