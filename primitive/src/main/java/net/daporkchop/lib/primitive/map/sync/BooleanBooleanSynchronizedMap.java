...
/**
 * A synchronized map, using a key type of boolean and a value type of boolean.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of BooleanBooleanMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class BooleanBooleanSynchronizedMap implements BooleanBooleanMap    {
    private final Object sync;
    private final BooleanBooleanMap map;

    public BooleanBooleanSynchronizedMap(BooleanBooleanMap map)    {
        this(map, map);
    }

    public BooleanBooleanSynchronizedMap(@NonNull BooleanBooleanMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
