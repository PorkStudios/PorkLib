...
/**
 * A map, using a key type of int and a value type of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface IntegerBooleanMap   {
    /**
     ...
     */
    default void putAll(@NonNull int[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull IntegerBooleanMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(IntegerBooleanConsumer consumer);
     ...
     */
    IntegerBooleanIterator entryIterator();
     ...
     */
    default boolean getOrDefault(int key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(int key, @NonNull IntegerToBooleanFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
