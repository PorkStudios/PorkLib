...
import net.daporkchop.lib.primitive.map.tree.LongShortTreeMap;
...
/**
 * A tree map, using a key type of long and a value type of short.
 ...
 * @author DaPorkchop_
 */
public class LongShortIndexedTreeMap extends LongShortTreeMap    {
    protected boolean[] index;

    public LongShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongShortIndexedTreeMap this_ = LongShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongShortIterator   {
        ...
        public LongShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
