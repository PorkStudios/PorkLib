...
/**
 * A synchronized map, using a key type of char and a value type of float.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of CharacterFloatMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class CharacterFloatSynchronizedMap implements CharacterFloatMap    {
    private final Object sync;
    private final CharacterFloatMap map;

    public CharacterFloatSynchronizedMap(CharacterFloatMap map)    {
        this(map, map);
    }

    public CharacterFloatSynchronizedMap(@NonNull CharacterFloatMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
