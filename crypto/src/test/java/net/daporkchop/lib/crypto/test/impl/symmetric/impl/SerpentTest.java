...
public class SerpentTest extends SymmetricCipherTest<SerpentKey, SerpentHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.SERPENT;
    }

    @Override
    public SerpentHelper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, SerpentKey key) {
        return new SerpentHelper(mode, scheme, key);
    }

    @Override
    public SerpentKey genKeys() {
        return SerpentKeyGen.gen();
    }
}
