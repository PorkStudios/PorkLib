...
/**
 * A map, using a key type of K and a value type of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ObjectBooleanMap<K extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull K[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull ObjectBooleanMap<K> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ObjectBooleanConsumer<K> consumer);
     ...
     */
    ObjectBooleanIterator entryIterator();
     ...
     */
    default boolean getOrDefault(K key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(K key, @NonNull ObjectToBooleanFunction<K> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
