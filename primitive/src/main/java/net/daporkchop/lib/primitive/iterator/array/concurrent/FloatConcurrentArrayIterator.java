...
/**
 * A concurrent iterator over an array of float.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class FloatConcurrentArrayIterator implements FloatConcurrentIterator  {
    private final float[] arr;
    private final AtomicInteger index = new AtomicInteger(0);
    private final ThreadLocal<AtomicInteger> tlIndex = ThreadLocal.withInitial(() -> new AtomicInteger(-1));

    public FloatConcurrentArrayIterator(@NonNull float[] arr)    {
        this.arr = arr;
    }
