...
import net.daporkchop.lib.primitive.map.tree.ShortBooleanTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ShortBooleanIndexedTreeMap extends ShortBooleanTreeMap    {
    protected boolean[] index;

    public ShortBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortBooleanIndexedTreeMap this_ = ShortBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortBooleanIterator   {
        ...
        public ShortBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
