...
/**
 * A synchronized map, using a key type of short and a value type of char.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ShortCharacterMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ShortCharacterSynchronizedMap implements ShortCharacterMap    {
    private final Object sync;
    private final ShortCharacterMap map;

    public ShortCharacterSynchronizedMap(ShortCharacterMap map)    {
        this(map, map);
    }

    public ShortCharacterSynchronizedMap(@NonNull ShortCharacterMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
