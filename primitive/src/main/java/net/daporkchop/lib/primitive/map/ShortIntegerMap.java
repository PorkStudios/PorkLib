...
/**
 * A map, using a key type of short and a value type of int.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ShortIntegerMap   {
    /**
     ...
     */
    default void putAll(@NonNull short[] keys, @NonNull int[] values)    {
     ...
     */
    default void putAll(@NonNull ShortIntegerMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ShortIntegerConsumer consumer);
     ...
     */
    ShortIntegerIterator entryIterator();
     ...
     */
    default int getOrDefault(short key, int def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default int computeIfAbsent(short key, @NonNull ShortToIntegerFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
