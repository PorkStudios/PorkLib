...
public enum TextFormat {
    ...
    private static final IntegerObjectMap<TextFormat> BY_ID = new IntegerObjectHashMap<>();
    private static final CharacterObjectMap<TextFormat> BY_CHAR = new CharacterObjectHashMap<>();
