...
import net.daporkchop.lib.primitive.map.tree.IntegerCharacterTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of char.
 ...
 * @author DaPorkchop_
 */
public class IntegerCharacterIndexedTreeMap extends IntegerCharacterTreeMap    {
    protected boolean[] index;

    public IntegerCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerCharacterIndexedTreeMap this_ = IntegerCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerCharacterIterator   {
        ...
        public IntegerCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
