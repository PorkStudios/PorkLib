...
import net.daporkchop.lib.primitive.lambda.function.DoubleToObjectFunction;
...
/**
 * A map, using a key type of double and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface DoubleObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull double[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull DoubleObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(DoubleObjectConsumer<V> consumer);
     ...
     */
    DoubleObjectIterator entryIterator();
     ...
     */
    default V getOrDefault(double key, V def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default V computeIfAbsent(double key, @NonNull DoubleToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
