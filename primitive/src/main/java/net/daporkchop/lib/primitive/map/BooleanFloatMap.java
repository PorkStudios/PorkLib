...
import net.daporkchop.lib.primitive.lambda.function.BooleanToFloatFunction;
...
/**
 * A map, using a key type of boolean and a value type of float.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanFloatMap   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull float[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanFloatMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanFloatConsumer consumer);
     ...
     */
    BooleanFloatIterator entryIterator();
     ...
     */
    default float putIfAbsent(boolean key, float value)  {
     ...
     */
    default float getOrDefault(boolean key, float def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default float computeIfAbsent(boolean key, @NonNull BooleanToFloatFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
