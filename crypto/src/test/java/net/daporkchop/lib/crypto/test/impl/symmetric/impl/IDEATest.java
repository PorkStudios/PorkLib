...
public class IDEATest extends SymmetricCipherTest<IDEAKey, IDEAHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.IDEA;
    }

    @Override
    public IDEAHelper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, IDEAKey key) {
        return new IDEAHelper(mode, scheme, key);
    }

    @Override
    public IDEAKey genKeys() {
        return IDEAKeyGen.gen();
    }
}
