...
import net.daporkchop.lib.primitive.map.tree.CharacterIntegerTreeMap;
...
/**
 * A tree map, using a key type of char and a value type of int.
 ...
 * @author DaPorkchop_
 */
public class CharacterIntegerIndexedTreeMap extends CharacterIntegerTreeMap    {
    protected boolean[] index;

    public CharacterIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterIntegerIndexedTreeMap this_ = CharacterIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterIntegerIterator   {
        ...
        public CharacterIntegerTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterIntegerImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
