...
import net.daporkchop.lib.primitive.map.tree.ByteIntegerTreeMap;
...
/**
 * A tree map, using a key type of byte and a value type of int.
 ...
 * @author DaPorkchop_
 */
public class ByteIntegerIndexedTreeMap extends ByteIntegerTreeMap    {
    protected boolean[] index;

    public ByteIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteIntegerIndexedTreeMap this_ = ByteIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteIntegerIterator   {
        ...
        public ByteIntegerTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteIntegerImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
