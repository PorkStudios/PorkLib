...
public class ByteArraySerializer extends ValueSerializer<byte[]> {
    @Getter
    private static final ValueSerializer<byte[]> instance = new ByteArraySerializer();

    private ByteArraySerializer() {
    }

    @Override
    public void write(byte[] value, DataOut out) throws IOException {
        out.writeBytesSimple(value);
    }

    @Override
    public byte[] read(DataIn in) throws IOException {
