...
/**
 * A concurrent iterator over an array of long.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class LongConcurrentArrayIterator implements LongConcurrentIterator  {
    private final long[] arr;
    private final AtomicInteger index = new AtomicInteger(0);
    private final ThreadLocal<AtomicInteger> tlIndex = ThreadLocal.withInitial(() -> new AtomicInteger(-1));

    public LongConcurrentArrayIterator(@NonNull long[] arr)    {
        this.arr = arr;
    }
