...
import net.daporkchop.lib.primitive.map.tree.CharacterObjectTreeMap;
...
/**
 * A tree map, using a key type of char and a value type of V.
 ...
 * @author DaPorkchop_
 */
public class CharacterObjectIndexedTreeMap<V extends Object> extends CharacterObjectTreeMap<V>    {
    protected boolean[] index;

    public CharacterObjectIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterObjectIndexedTreeMap this_ = CharacterObjectIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterObjectIterator<V>   {
        ...
        public CharacterObjectTuple<V> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterObjectImmutableTuple<V>( this_.keys[this.index],  (V) this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
