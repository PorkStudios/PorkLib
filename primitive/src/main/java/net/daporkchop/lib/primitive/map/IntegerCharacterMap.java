...
import net.daporkchop.lib.primitive.lambda.function.IntegerToCharacterFunction;
...
/**
 * A map, using a key type of int and a value type of char.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface IntegerCharacterMap   {
    /**
     ...
     */
    default void putAll(@NonNull int[] keys, @NonNull char[] values)    {
     ...
     */
    default void putAll(@NonNull IntegerCharacterMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(IntegerCharacterConsumer consumer);
     ...
     */
    IntegerCharacterIterator entryIterator();
     ...
     */
    default char getOrDefault(int key, char def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default char computeIfAbsent(int key, @NonNull IntegerToCharacterFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
