...
/**
 * A map, using a key type of K and a value type of int.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ObjectIntegerMap<K extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull K[] keys, @NonNull int[] values)    {
     ...
     */
    default void putAll(@NonNull ObjectIntegerMap<K> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ObjectIntegerConsumer<K> consumer);
     ...
     */
    ObjectIntegerIterator entryIterator();
     ...
     */
    default int computeIfAbsent(K key, @NonNull ObjectToIntegerFunction<K> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
