...
import net.daporkchop.lib.primitive.lambda.function.BooleanToBooleanFunction;
...
/**
 * A map, using a key type of boolean and a value type of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanBooleanMap   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanBooleanMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanBooleanConsumer consumer);
     ...
     */
    BooleanBooleanIterator entryIterator();
     ...
     */
    default boolean getOrDefault(boolean key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(boolean key, @NonNull BooleanToBooleanFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
