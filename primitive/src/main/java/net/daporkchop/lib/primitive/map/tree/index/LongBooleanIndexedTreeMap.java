...
import net.daporkchop.lib.primitive.map.tree.LongBooleanTreeMap;
 ...
 * @author DaPorkchop_
 */
public class LongBooleanIndexedTreeMap extends LongBooleanTreeMap    {
    protected boolean[] index;

    public LongBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongBooleanIndexedTreeMap this_ = LongBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongBooleanIterator   {
        ...
        public LongBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
