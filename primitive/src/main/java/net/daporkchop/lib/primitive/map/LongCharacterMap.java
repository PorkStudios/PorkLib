...
import net.daporkchop.lib.primitive.lambda.function.LongToCharacterFunction;
...
/**
 * A map, using a key type of long and a value type of char.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface LongCharacterMap   {
    /**
     ...
     */
    default void putAll(@NonNull long[] keys, @NonNull char[] values)    {
     ...
     */
    default void putAll(@NonNull LongCharacterMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(LongCharacterConsumer consumer);
     ...
     */
    LongCharacterIterator entryIterator();
     ...
     */
    default char getOrDefault(long key, char def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default char computeIfAbsent(long key, @NonNull LongToCharacterFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
