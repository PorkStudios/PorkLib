...
import net.daporkchop.lib.primitive.map.tree.BooleanDoubleTreeMap;
 ...
 * @author DaPorkchop_
 */
public class BooleanDoubleIndexedTreeMap extends BooleanDoubleTreeMap    {
    protected boolean[] index;

    public BooleanDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanDoubleIndexedTreeMap this_ = BooleanDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanDoubleIterator   {
        ...
        public BooleanDoubleTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanDoubleImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
