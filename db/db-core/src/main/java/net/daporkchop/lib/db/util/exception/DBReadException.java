 ...
 * @author DaPorkchop_
 */
public class DBReadException extends DBIOException {
    ...
    protected DBReadException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
