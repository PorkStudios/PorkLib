...
import net.daporkchop.lib.primitive.map.tree.FloatShortTreeMap;
 ...
 * @author DaPorkchop_
 */
public class FloatShortIndexedTreeMap extends FloatShortTreeMap    {
    protected boolean[] index;

    public FloatShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatShortIndexedTreeMap this_ = FloatShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatShortIterator   {
        ...
        public FloatShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
