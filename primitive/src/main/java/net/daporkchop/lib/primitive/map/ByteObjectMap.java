...
import net.daporkchop.lib.primitive.lambda.function.ByteToObjectFunction;
...
/**
 * A map, using a key type of byte and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ByteObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull byte[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull ByteObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ByteObjectConsumer<V> consumer);
     ...
     */
    ByteObjectIterator entryIterator();
     ...
     */
    default V getOrDefault(byte key, V def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default V computeIfAbsent(byte key, @NonNull ByteToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
