...
import net.daporkchop.lib.primitive.map.tree.BooleanBooleanTreeMap;
 ...
 * @author DaPorkchop_
 */
public class BooleanBooleanIndexedTreeMap extends BooleanBooleanTreeMap    {
    protected boolean[] index;

    public BooleanBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanBooleanIndexedTreeMap this_ = BooleanBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanBooleanIterator   {
        ...
        public BooleanBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
