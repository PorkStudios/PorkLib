...
import net.daporkchop.lib.primitive.map.tree.ShortDoubleTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ShortDoubleIndexedTreeMap extends ShortDoubleTreeMap    {
    protected boolean[] index;

    public ShortDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortDoubleIndexedTreeMap this_ = ShortDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortDoubleIterator   {
        ...
        public ShortDoubleTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortDoubleImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
