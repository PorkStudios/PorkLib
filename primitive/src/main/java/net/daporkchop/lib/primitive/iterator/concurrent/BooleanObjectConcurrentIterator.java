...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanObjectToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => V mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface BooleanObjectConcurrentIterator<V extends Object> extends BooleanObjectIterator<V>   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanObjectToBooleanFunction<V> function)    {
        try {
            while (this.hasNext())  {
                BooleanObjectTuple<V> tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanObjectTuple<V>> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanObjectTuple<V>> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanObjectConsumer<V> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanObjectTuple<V>> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanObjectToBooleanFunction<V> function)    {
        this.concurrentIterate(function);
    }
}
