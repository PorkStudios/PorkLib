...
import net.daporkchop.lib.primitive.map.tree.FloatCharacterTreeMap;
 ...
 * @author DaPorkchop_
 */
public class FloatCharacterIndexedTreeMap extends FloatCharacterTreeMap    {
    protected boolean[] index;

    public FloatCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatCharacterIndexedTreeMap this_ = FloatCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatCharacterIterator   {
        ...
        public FloatCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
