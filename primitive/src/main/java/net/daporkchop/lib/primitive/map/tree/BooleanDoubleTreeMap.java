...
/**
 * A tree map, using a key type of boolean and a value type of double.
 ...
 * Although this map WORKS, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.BooleanDoubleIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class BooleanDoubleTreeMap implements BooleanDoubleMap    {
    ...
    @SuppressWarnings("unchecked")
    protected double remove(boolean key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return 0D; //no mapping
    ...
    public BooleanIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.BooleanDoubleIndexedTreeMap} for an implementation of this method
        return null;
    }
