...
import net.daporkchop.lib.primitive.lambda.function.FloatToObjectFunction;
...
/**
 * A map, using a key type of float and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface FloatObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull float[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull FloatObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(FloatObjectConsumer<V> consumer);
     ...
     */
    FloatObjectIterator entryIterator();
     ...
     */
    default V getOrDefault(float key, V def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default V computeIfAbsent(float key, @NonNull FloatToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
