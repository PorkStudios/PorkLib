...
import net.daporkchop.lib.primitive.map.tree.LongCharacterTreeMap;
...
/**
 * A tree map, using a key type of long and a value type of char.
 ...
 * @author DaPorkchop_
 */
public class LongCharacterIndexedTreeMap extends LongCharacterTreeMap    {
    protected boolean[] index;

    public LongCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongCharacterIndexedTreeMap this_ = LongCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongCharacterIterator   {
        ...
        public LongCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
