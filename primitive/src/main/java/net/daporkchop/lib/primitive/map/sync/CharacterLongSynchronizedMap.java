...
/**
 * A synchronized map, using a key type of char and a value type of long.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of CharacterLongMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class CharacterLongSynchronizedMap implements CharacterLongMap    {
    private final Object sync;
    private final CharacterLongMap map;

    public CharacterLongSynchronizedMap(CharacterLongMap map)    {
        this(map, map);
    }

    public CharacterLongSynchronizedMap(@NonNull CharacterLongMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
