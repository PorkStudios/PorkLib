 ...
 * @author DaPorkchop_
 */
public final class MulFilter extends FilterNoiseSource {
    private final double val;

    public MulFilter(@NonNull NoiseSource delegate, double val) {
        super(delegate);

        this.val = val;
    }

    public MulFilter(@NonNull NoiseFactory factory, @NonNull PRandom random, double val) {
