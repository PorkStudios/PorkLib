...
/**
 * A synchronized map, using a key type of float and a value type of boolean.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of FloatBooleanMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class FloatBooleanSynchronizedMap implements FloatBooleanMap    {
    private final Object sync;
    private final FloatBooleanMap map;

    public FloatBooleanSynchronizedMap(FloatBooleanMap map)    {
        this(map, map);
    }

    public FloatBooleanSynchronizedMap(@NonNull FloatBooleanMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
