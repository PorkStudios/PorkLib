...
import net.daporkchop.lib.primitive.map.tree.DoubleBooleanTreeMap;
 ...
 * @author DaPorkchop_
 */
public class DoubleBooleanIndexedTreeMap extends DoubleBooleanTreeMap    {
    protected boolean[] index;

    public DoubleBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleBooleanIndexedTreeMap this_ = DoubleBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleBooleanIterator   {
        ...
        public DoubleBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
