...
/**
 * A synchronized map, using a key type of byte and a value type of char.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ByteCharacterMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ByteCharacterSynchronizedMap implements ByteCharacterMap    {
    private final Object sync;
    private final ByteCharacterMap map;

    public ByteCharacterSynchronizedMap(ByteCharacterMap map)    {
        this(map, map);
    }

    public ByteCharacterSynchronizedMap(@NonNull ByteCharacterMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
