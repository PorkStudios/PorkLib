...
import net.daporkchop.lib.primitive.map.tree.CharacterBooleanTreeMap;
 ...
 * @author DaPorkchop_
 */
public class CharacterBooleanIndexedTreeMap extends CharacterBooleanTreeMap    {
    protected boolean[] index;

    public CharacterBooleanIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterBooleanIndexedTreeMap this_ = CharacterBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterBooleanIterator   {
        ...
        public CharacterBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
