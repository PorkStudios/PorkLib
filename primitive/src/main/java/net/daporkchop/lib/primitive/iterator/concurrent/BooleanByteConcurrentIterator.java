...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanByteToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => byte mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface BooleanByteConcurrentIterator extends BooleanByteIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanByteToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                BooleanByteTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanByteTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanByteTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanByteConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanByteTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanByteToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
