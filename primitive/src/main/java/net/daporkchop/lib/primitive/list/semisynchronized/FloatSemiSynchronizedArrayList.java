 ...
 * @author DaPorkchop_
 */
public class FloatSemiSynchronizedArrayList implements FloatList   {
    private int size = 0, len;

    private float[] backing;

    public FloatSemiSynchronizedArrayList()  {
        this.clear();
    }
    ...
    private class Iterator implements FloatIterator  {
        private final FloatSemiSynchronizedArrayList this_ = FloatSemiSynchronizedArrayList.this;
        private int index;
