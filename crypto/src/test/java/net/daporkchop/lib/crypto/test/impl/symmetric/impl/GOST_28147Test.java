...
public class GOST_28147Test extends SymmetricCipherTest<GOST_28147Key, GOST_28147Helper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.GOST_28147;
    }

    @Override
    public GOST_28147Helper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, GOST_28147Key key) {
        return new GOST_28147Helper(mode, scheme, key);
    }

    @Override
    public GOST_28147Key genKeys() {
        return GOST_28147KeyGen.gen();
    }
}
