...
import net.daporkchop.lib.primitive.map.tree.DoubleObjectTreeMap;
 ...
 * @author DaPorkchop_
 */
public class DoubleObjectIndexedTreeMap<V extends Object> extends DoubleObjectTreeMap<V>    {
    protected boolean[] index;

    public DoubleObjectIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleObjectIndexedTreeMap this_ = DoubleObjectIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleObjectIterator<V>   {
        ...
        public DoubleObjectTuple<V> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleObjectImmutableTuple<V>( this_.keys[this.index],  (V) this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
