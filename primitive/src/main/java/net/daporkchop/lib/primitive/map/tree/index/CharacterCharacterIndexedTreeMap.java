...
import net.daporkchop.lib.primitive.map.tree.CharacterCharacterTreeMap;
 ...
 * @author DaPorkchop_
 */
public class CharacterCharacterIndexedTreeMap extends CharacterCharacterTreeMap    {
    protected boolean[] index;

    public CharacterCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterCharacterIndexedTreeMap this_ = CharacterCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterCharacterIterator   {
        ...
        public CharacterCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
