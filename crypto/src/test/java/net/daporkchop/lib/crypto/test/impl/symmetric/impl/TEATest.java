...
public class TEATest extends SymmetricCipherTest<TEAKey, TEAHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.TEA;
    }

    @Override
    public TEAHelper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, TEAKey key) {
        return new TEAHelper(mode, scheme, key);
    }

    @Override
    public TEAKey genKeys() {
        return TEAKeyGen.gen();
    }
}
