...
/**
 * A map, using a key type of boolean and a value type of int.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanIntegerMap   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull int[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanIntegerMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanIntegerConsumer consumer);
     ...
     */
    BooleanIntegerIterator entryIterator();
     ...
     */
    default int putIfAbsent(boolean key, int value)  {
     ...
     */
    default int getOrDefault(boolean key, int def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default int computeIfAbsent(boolean key, @NonNull BooleanToIntegerFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
