...
import net.daporkchop.lib.primitive.lambda.function.bi.ShortDoubleToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of short => double mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface ShortDoubleConcurrentIterator extends ShortDoubleIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ShortDoubleToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                ShortDoubleTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<ShortDoubleTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<ShortDoubleTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ShortDoubleConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<ShortDoubleTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull ShortDoubleToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
