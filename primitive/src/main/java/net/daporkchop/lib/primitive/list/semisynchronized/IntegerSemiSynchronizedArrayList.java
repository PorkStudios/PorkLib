 ...
 * @author DaPorkchop_
 */
public class IntegerSemiSynchronizedArrayList implements IntegerList   {
    private int size = 0, len;

    private int[] backing;

    public IntegerSemiSynchronizedArrayList()  {
        this.clear();
    }
    ...
    private class Iterator implements IntegerIterator  {
        private final IntegerSemiSynchronizedArrayList this_ = IntegerSemiSynchronizedArrayList.this;
        private int index;
