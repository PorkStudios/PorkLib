...
import net.daporkchop.lib.primitive.lambda.function.FloatToDoubleFunction;
...
/**
 * A map, using a key type of float and a value type of double.
 * <p>
...
public interface FloatDoubleMap   {
     ...
     */
    default void putAll(@NonNull float[] keys, @NonNull double[] values)    {
     ...
     */
    default void putAll(@NonNull FloatDoubleMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(FloatDoubleConsumer consumer);
     ...
     */
    FloatDoubleIterator entryIterator();
     ...
     */
    default double getOrDefault(float key, double def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default double computeIfAbsent(float key, @NonNull FloatToDoubleFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
