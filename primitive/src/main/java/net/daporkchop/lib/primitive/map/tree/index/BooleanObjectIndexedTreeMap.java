...
import net.daporkchop.lib.primitive.map.tree.BooleanObjectTreeMap;
 ...
 * @author DaPorkchop_
 */
public class BooleanObjectIndexedTreeMap<V extends Object> extends BooleanObjectTreeMap<V>    {
    protected boolean[] index;

    public BooleanObjectIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanObjectIndexedTreeMap this_ = BooleanObjectIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanObjectIterator<V>   {
        ...
        public BooleanObjectTuple<V> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanObjectImmutableTuple<V>( this_.keys[this.index],  (V) this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
