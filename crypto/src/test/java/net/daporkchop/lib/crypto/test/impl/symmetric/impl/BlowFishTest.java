...
public class BlowFishTest extends SymmetricCipherTest<BlowFishKey, BlowFishHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.BLOWFISH;
    }

    @Override
    public BlowFishHelper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, BlowFishKey key) {
        return new BlowFishHelper(mode, scheme, key);
    }

    @Override
    public BlowFishKey genKeys() {
        return BlowFishKeyGen.gen();
    }
}
