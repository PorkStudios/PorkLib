...
import net.daporkchop.lib.primitive.map.tree.DoubleFloatTreeMap;
 ...
 * @author DaPorkchop_
 */
public class DoubleFloatIndexedTreeMap extends DoubleFloatTreeMap    {
    protected boolean[] index;

    public DoubleFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleFloatIndexedTreeMap this_ = DoubleFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleFloatIterator   {
        ...
        public DoubleFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
