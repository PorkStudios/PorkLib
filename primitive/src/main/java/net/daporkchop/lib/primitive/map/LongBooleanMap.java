...
/**
 * A map, using a key type of long and a value type of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface LongBooleanMap   {
    /**
     ...
     */
    default void putAll(@NonNull long[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull LongBooleanMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(LongBooleanConsumer consumer);
     ...
     */
    LongBooleanIterator entryIterator();
     ...
     */
    default boolean getOrDefault(long key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(long key, @NonNull LongToBooleanFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
