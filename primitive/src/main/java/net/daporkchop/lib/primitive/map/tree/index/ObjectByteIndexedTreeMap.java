...
import net.daporkchop.lib.primitive.map.tree.ObjectByteTreeMap;
...
/**
 * A tree map, using a key type of K and a value type of byte.
 ...
 * @author DaPorkchop_
 */
public class ObjectByteIndexedTreeMap<K extends Object> extends ObjectByteTreeMap<K>    {
    protected boolean[] index;

    public ObjectByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ObjectIterator<K>   {
        ...
        private final ObjectByteIndexedTreeMap this_ = ObjectByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements ObjectByteIterator<K>   {
        ...
        public ObjectByteTuple<K> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ObjectByteImmutableTuple<K>( (K) this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
