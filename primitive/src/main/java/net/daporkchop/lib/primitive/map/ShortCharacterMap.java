...
import net.daporkchop.lib.primitive.lambda.function.ShortToCharacterFunction;
...
/**
 * A map, using a key type of short and a value type of char.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ShortCharacterMap   {
    /**
     ...
     */
    default void putAll(@NonNull short[] keys, @NonNull char[] values)    {
     ...
     */
    default void putAll(@NonNull ShortCharacterMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ShortCharacterConsumer consumer);
     ...
     */
    ShortCharacterIterator entryIterator();
     ...
     */
    default char getOrDefault(short key, char def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default char computeIfAbsent(short key, @NonNull ShortToCharacterFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
