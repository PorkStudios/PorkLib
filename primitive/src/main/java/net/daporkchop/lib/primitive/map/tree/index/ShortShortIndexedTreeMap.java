...
import net.daporkchop.lib.primitive.map.tree.ShortShortTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ShortShortIndexedTreeMap extends ShortShortTreeMap    {
    protected boolean[] index;

    public ShortShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortShortIndexedTreeMap this_ = ShortShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortShortIterator   {
        ...
        public ShortShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
