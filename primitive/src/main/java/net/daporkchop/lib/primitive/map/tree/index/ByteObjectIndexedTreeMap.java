...
import net.daporkchop.lib.primitive.map.tree.ByteObjectTreeMap;
...
/**
 * A tree map, using a key type of byte and a value type of V.
 ...
 * @author DaPorkchop_
 */
public class ByteObjectIndexedTreeMap<V extends Object> extends ByteObjectTreeMap<V>    {
    protected boolean[] index;

    public ByteObjectIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteObjectIndexedTreeMap this_ = ByteObjectIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteObjectIterator<V>   {
        ...
        public ByteObjectTuple<V> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteObjectImmutableTuple<V>( this_.keys[this.index],  (V) this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
