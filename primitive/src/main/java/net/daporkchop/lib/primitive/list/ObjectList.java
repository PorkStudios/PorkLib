 ...
 * @author DaPorkchop_
 */
public interface ObjectList<K extends Object>   {
    /**
     * Get an element at the specified index
     *
     * @param index The index of the element to get
     * @return the element at to the given index, or null if no such mapping exists
     */
    K get(int index);
     ...
     */
    default void addAll(@NonNull ObjectList<K> list)    {
