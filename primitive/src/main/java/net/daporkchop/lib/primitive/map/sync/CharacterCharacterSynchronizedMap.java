...
/**
 * A synchronized map, using a key type of char and a value type of char.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of CharacterCharacterMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class CharacterCharacterSynchronizedMap implements CharacterCharacterMap    {
    private final Object sync;
    private final CharacterCharacterMap map;

    public CharacterCharacterSynchronizedMap(CharacterCharacterMap map)    {
        this(map, map);
    }

    public CharacterCharacterSynchronizedMap(@NonNull CharacterCharacterMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
