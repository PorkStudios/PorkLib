...
import net.daporkchop.lib.primitive.map.tree.IntegerBooleanTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of boolean.
 ...
 * @author DaPorkchop_
 */
public class IntegerBooleanIndexedTreeMap extends IntegerBooleanTreeMap    {
    protected boolean[] index;

    public IntegerBooleanIndexedTreeMap()    {
        super();
    }
    ...
    protected void doResize(int oldSize, int newSize) {
        ...
        int[] newKeys = new int[len];
        boolean[] newValues = new boolean[len];
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerBooleanIndexedTreeMap this_ = IntegerBooleanIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerBooleanIterator   {
        ...
        public IntegerBooleanTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerBooleanImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
