 ...
 */
@FunctionalInterface
public interface BBUpdater<Impl extends Element<Impl>> {
    @SuppressWarnings("unchecked")
    static <Impl extends Element<Impl>> BBUpdater<Impl> of(@NonNull Object x, @NonNull Object y, @NonNull Object width, @NonNull Object height) {
    ...
    static <Impl extends Element<Impl>> BBUpdater<Impl> of(@NonNull SingleValueCalculator<Impl> x, @NonNull SingleValueCalculator<Impl> y, @NonNull SingleValueCalculator<Impl> width, @NonNull SingleValueCalculator<Impl> height) {
    ...
    @FunctionalInterface
    interface SingleValueCalculator<Impl extends Element<Impl>> {
        /**
