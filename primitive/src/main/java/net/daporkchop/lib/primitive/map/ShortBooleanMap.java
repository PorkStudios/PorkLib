...
import net.daporkchop.lib.primitive.lambda.function.ShortToBooleanFunction;
...
/**
 * A map, using a key type of short and a value type of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ShortBooleanMap   {
    /**
     ...
     */
    default void putAll(@NonNull short[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull ShortBooleanMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ShortBooleanConsumer consumer);
     ...
     */
    ShortBooleanIterator entryIterator();
     ...
     */
    default boolean getOrDefault(short key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(short key, @NonNull ShortToBooleanFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
