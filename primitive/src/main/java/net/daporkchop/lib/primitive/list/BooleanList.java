...
public interface BooleanList   {
     ...
     * @return the element at to the given index, or false if no such mapping exists
     */
     ...
     */
    void add(boolean value, int index);
     ...
     */
    void set(boolean value, int index);
     ...
     */
    default void addAll(@NonNull BooleanList list)    {
