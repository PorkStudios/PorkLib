...
public class DSTU_7624_128Test extends SymmetricCipherTest<DSTU_7624_128Key, DSTU_7624_128Helper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.DSTU_7624_128;
    }

    @Override
    public DSTU_7624_128Helper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, DSTU_7624_128Key key) {
        return new DSTU_7624_128Helper(mode, scheme, key);
    }

    @Override
    public DSTU_7624_128Key genKeys() {
        return DSTU_7624_128KeyGen.gen();
    }
}
