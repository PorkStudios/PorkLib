...
import net.daporkchop.lib.primitive.map.tree.DoubleDoubleTreeMap;
...
/**
 * A tree map, using a key type of double and a value type of double.
 ...
 * @author DaPorkchop_
 */
public class DoubleDoubleIndexedTreeMap extends DoubleDoubleTreeMap    {
    protected boolean[] index;

    public DoubleDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleDoubleIndexedTreeMap this_ = DoubleDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleDoubleIterator   {
        ...
        public DoubleDoubleTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleDoubleImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
