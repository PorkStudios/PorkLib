...
import net.daporkchop.lib.primitive.map.tree.ByteCharacterTreeMap;
...
/**
 * A tree map, using a key type of byte and a value type of char.
 ...
 * @author DaPorkchop_
 */
public class ByteCharacterIndexedTreeMap extends ByteCharacterTreeMap    {
    protected boolean[] index;

    public ByteCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteCharacterIndexedTreeMap this_ = ByteCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteCharacterIterator   {
        ...
        public ByteCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
