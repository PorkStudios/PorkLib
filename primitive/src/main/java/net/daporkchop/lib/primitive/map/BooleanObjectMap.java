...
import net.daporkchop.lib.primitive.lambda.function.BooleanToObjectFunction;
...
/**
 * A map, using a key type of boolean and a value type of V.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanObjectMap<V extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull V[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanObjectMap<V> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanObjectConsumer<V> consumer);
     ...
     */
    BooleanObjectIterator entryIterator();
     ...
     */
    default V putIfAbsent(boolean key, V value)  {
     ...
     */
    default V getOrDefault(boolean key, V def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default V computeIfAbsent(boolean key, @NonNull BooleanToObjectFunction<V> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
