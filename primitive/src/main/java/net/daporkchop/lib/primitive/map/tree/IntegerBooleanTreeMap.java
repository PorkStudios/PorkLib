 ...
 * Although this map 𝙒𝙊𝙍𝙆𝙎, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.IntegerBooleanIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class IntegerBooleanTreeMap implements IntegerBooleanMap    {
    protected int[] keys;
    ...
    public boolean get(int key)    {
        ...
        if (!containsKeyHash(hash)) return false; //no mapping
    ...
    @SuppressWarnings("unchecked")
    protected boolean remove(int key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return false; //no mapping
    ...
    public IntegerIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.IntegerBooleanIndexedTreeMap} for an implementation of this method
        return null;
    }
