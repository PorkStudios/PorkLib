 ...
 * @author DaPorkchop_
 */
public class LongSemiSynchronizedArrayList implements LongList   {
    private int size = 0, len;

    private long[] backing;

    public LongSemiSynchronizedArrayList()  {
        this.clear();
    }
    ...
    private class Iterator implements LongIterator  {
        private final LongSemiSynchronizedArrayList this_ = LongSemiSynchronizedArrayList.this;
        private int index;
