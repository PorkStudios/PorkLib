...
public class CamelliaTest extends SymmetricCipherTest<CamelliaKey, CamelliaHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.CAMELLIA;
    }
    ...
    @Override
    public CamelliaKey genKeys() {
        return CamelliaKeyGen.gen();
    }
}
