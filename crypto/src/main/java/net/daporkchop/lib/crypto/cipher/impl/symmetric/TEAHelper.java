...
public class TEAHelper extends BlockCipherHelper<TEAKey> {
    public TEAHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull TEAKey key) {
        this(mode, scheme, key, UpdaterMode.HASH_SHA_256);
    }

    public TEAHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull TEAKey key, @NonNull UpdaterMode updater) {
