...
import net.daporkchop.lib.primitive.map.tree.LongByteTreeMap;
 ...
 * @author DaPorkchop_
 */
public class LongByteIndexedTreeMap extends LongByteTreeMap    {
    protected boolean[] index;

    public LongByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongByteIndexedTreeMap this_ = LongByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongByteIterator   {
        ...
        public LongByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
