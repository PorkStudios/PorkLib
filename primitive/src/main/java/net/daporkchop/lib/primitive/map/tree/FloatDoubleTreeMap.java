 ...
 * Although this map WORKS, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.FloatDoubleIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class FloatDoubleTreeMap implements FloatDoubleMap    {
    ...
    @SuppressWarnings("unchecked")
    protected double remove(float key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return 0D; //no mapping
    ...
    public FloatIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.FloatDoubleIndexedTreeMap} for an implementation of this method
        return null;
    }
