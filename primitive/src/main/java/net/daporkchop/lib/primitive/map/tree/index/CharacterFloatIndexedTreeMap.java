...
import net.daporkchop.lib.primitive.map.tree.CharacterFloatTreeMap;
 ...
 * @author DaPorkchop_
 */
public class CharacterFloatIndexedTreeMap extends CharacterFloatTreeMap    {
    protected boolean[] index;

    public CharacterFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterFloatIndexedTreeMap this_ = CharacterFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterFloatIterator   {
        ...
        public CharacterFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
