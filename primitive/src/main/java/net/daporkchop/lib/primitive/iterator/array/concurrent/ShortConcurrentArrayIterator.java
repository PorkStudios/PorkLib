...
/**
 * A concurrent iterator over an array of short.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ShortConcurrentArrayIterator implements ShortConcurrentIterator  {
    ...
    public ShortConcurrentArrayIterator(@NonNull short[] arr)    {
        this.arr = arr;
    }
