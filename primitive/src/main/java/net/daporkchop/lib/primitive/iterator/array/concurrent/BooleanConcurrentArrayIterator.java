...
/**
 * A concurrent iterator over an array of boolean.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class BooleanConcurrentArrayIterator implements BooleanConcurrentIterator  {
    private final boolean[] arr;
    private final AtomicInteger index = new AtomicInteger(0);
    private final ThreadLocal<AtomicInteger> tlIndex = ThreadLocal.withInitial(() -> new AtomicInteger(-1));

    public BooleanConcurrentArrayIterator(@NonNull boolean[] arr)    {
        this.arr = arr;
    }
