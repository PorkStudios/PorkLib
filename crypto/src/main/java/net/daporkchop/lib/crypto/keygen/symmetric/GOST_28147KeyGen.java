...
public class GOST_28147KeyGen {
    static {
        BouncyCastleInit.loadClass();
    }

    public static GOST_28147Key gen(byte[] data) {
        byte[] b = new byte[32];
        int i = 0;
        do {
        ...
        data = b;
        return new GOST_28147Key(new SecretKeySpec(data, "aaa"), KeyRandom.getBytes(BlockCipherType.GOST_28147.blockSize));
    }

    public static GOST_28147Key gen() {
