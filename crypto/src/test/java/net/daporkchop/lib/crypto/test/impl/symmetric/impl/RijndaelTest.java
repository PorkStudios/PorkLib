...
public class RijndaelTest extends SymmetricCipherTest<RijndaelKey, RijndaelHelper> {
    @Override
    public BlockCipherType getType() {
        return BlockCipherType.RIJNDAEL;
    }

    @Override
    public RijndaelHelper getHelper(BlockCipherMode mode, BlockCipherPadding scheme, RijndaelKey key) {
        return new RijndaelHelper(mode, scheme, key);
    }

    @Override
    public RijndaelKey genKeys() {
        return RijndaelKeyGen.gen();
    }
}
