...
import net.daporkchop.lib.primitive.map.tree.ByteDoubleTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ByteDoubleIndexedTreeMap extends ByteDoubleTreeMap    {
    protected boolean[] index;

    public ByteDoubleIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ByteIterator   {
        ...
        private final ByteDoubleIndexedTreeMap this_ = ByteDoubleIndexedTreeMap.this;
    ...
    private class EntryIterator implements ByteDoubleIterator   {
        ...
        public ByteDoubleTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ByteDoubleImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
