...
import net.daporkchop.lib.primitive.lambda.function.DoubleToDoubleFunction;
...
/**
 * A map, using a key type of double and a value type of double.
 * <p>
...
public interface DoubleDoubleMap   {
     ...
     */
    default void putAll(@NonNull double[] keys, @NonNull double[] values)    {
     ...
     */
    default void putAll(@NonNull DoubleDoubleMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(DoubleDoubleConsumer consumer);
     ...
     */
    DoubleDoubleIterator entryIterator();
     ...
     */
    default double computeIfAbsent(double key, @NonNull DoubleToDoubleFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
