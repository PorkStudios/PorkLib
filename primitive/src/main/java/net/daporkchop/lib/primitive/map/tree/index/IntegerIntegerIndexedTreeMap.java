...
import net.daporkchop.lib.primitive.map.tree.IntegerIntegerTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of int.
 ...
 * @author DaPorkchop_
 */
public class IntegerIntegerIndexedTreeMap extends IntegerIntegerTreeMap    {
    protected boolean[] index;

    public IntegerIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerIntegerIndexedTreeMap this_ = IntegerIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerIntegerIterator   {
        ...
        public IntegerIntegerTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerIntegerImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
