...
/**
 * A map, using a key type of double and a value type of long.
 * <p>
...
public interface DoubleLongMap   {
     ...
     */
    default void putAll(@NonNull double[] keys, @NonNull long[] values)    {
     ...
     */
    default void putAll(@NonNull DoubleLongMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(DoubleLongConsumer consumer);
     ...
     */
    DoubleLongIterator entryIterator();
     ...
     */
    default long computeIfAbsent(double key, @NonNull DoubleToLongFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
