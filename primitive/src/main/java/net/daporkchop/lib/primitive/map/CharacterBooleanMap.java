...
import net.daporkchop.lib.primitive.lambda.function.CharacterToBooleanFunction;
...
public interface CharacterBooleanMap   {
     ...
     */
    default void putAll(@NonNull char[] keys, @NonNull boolean[] values)    {
     ...
     */
    default void putAll(@NonNull CharacterBooleanMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(CharacterBooleanConsumer consumer);
     ...
     */
    CharacterBooleanIterator entryIterator();
     ...
     */
    default boolean getOrDefault(char key, boolean def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default boolean computeIfAbsent(char key, @NonNull CharacterToBooleanFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
