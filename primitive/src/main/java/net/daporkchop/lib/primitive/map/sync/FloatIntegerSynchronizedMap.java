...
/**
 * A synchronized map, using a key type of float and a value type of int.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of FloatIntegerMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class FloatIntegerSynchronizedMap implements FloatIntegerMap    {
    private final Object sync;
    private final FloatIntegerMap map;

    public FloatIntegerSynchronizedMap(FloatIntegerMap map)    {
        this(map, map);
    }

    public FloatIntegerSynchronizedMap(@NonNull FloatIntegerMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
