...
import net.daporkchop.lib.primitive.map.tree.DoubleByteTreeMap;
 ...
 * @author DaPorkchop_
 */
public class DoubleByteIndexedTreeMap extends DoubleByteTreeMap    {
    protected boolean[] index;

    public DoubleByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleByteIndexedTreeMap this_ = DoubleByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleByteIterator   {
        ...
        public DoubleByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
