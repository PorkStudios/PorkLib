...
import net.daporkchop.lib.primitive.lambda.function.BooleanToShortFunction;
...
/**
 * A map, using a key type of boolean and a value type of short.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanShortMap   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull short[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanShortMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanShortConsumer consumer);
     ...
     */
    BooleanShortIterator entryIterator();
     ...
     */
    default short putIfAbsent(boolean key, short value)  {
     ...
     */
    default short getOrDefault(boolean key, short def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default short computeIfAbsent(boolean key, @NonNull BooleanToShortFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
