...
/**
 * A synchronized map, using a key type of int and a value type of float.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of IntegerFloatMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class IntegerFloatSynchronizedMap implements IntegerFloatMap    {
    private final Object sync;
    private final IntegerFloatMap map;

    public IntegerFloatSynchronizedMap(IntegerFloatMap map)    {
        this(map, map);
    }

    public IntegerFloatSynchronizedMap(@NonNull IntegerFloatMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
