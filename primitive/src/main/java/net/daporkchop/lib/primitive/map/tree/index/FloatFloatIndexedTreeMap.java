...
import net.daporkchop.lib.primitive.map.tree.FloatFloatTreeMap;
...
/**
 * A tree map, using a key type of float and a value type of float.
 ...
 * @author DaPorkchop_
 */
public class FloatFloatIndexedTreeMap extends FloatFloatTreeMap    {
    protected boolean[] index;

    public FloatFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements FloatIterator   {
        ...
        private final FloatFloatIndexedTreeMap this_ = FloatFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements FloatFloatIterator   {
        ...
        public FloatFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new FloatFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
