...
import net.daporkchop.lib.primitive.map.tree.LongLongTreeMap;
 ...
 * @author DaPorkchop_
 */
public class LongLongIndexedTreeMap extends LongLongTreeMap    {
    protected boolean[] index;

    public LongLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongLongIndexedTreeMap this_ = LongLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongLongIterator   {
        ...
        public LongLongTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongLongImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
