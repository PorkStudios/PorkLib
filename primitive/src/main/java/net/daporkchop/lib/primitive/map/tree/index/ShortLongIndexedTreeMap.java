...
import net.daporkchop.lib.primitive.map.tree.ShortLongTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ShortLongIndexedTreeMap extends ShortLongTreeMap    {
    protected boolean[] index;

    public ShortLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortLongIndexedTreeMap this_ = ShortLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortLongIterator   {
        ...
        public ShortLongTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortLongImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
