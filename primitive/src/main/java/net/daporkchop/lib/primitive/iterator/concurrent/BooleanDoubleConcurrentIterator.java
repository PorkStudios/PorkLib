...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanDoubleToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => double mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface BooleanDoubleConcurrentIterator extends BooleanDoubleIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanDoubleToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                BooleanDoubleTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanDoubleTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanDoubleTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanDoubleConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanDoubleTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanDoubleToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
