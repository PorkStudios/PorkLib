...
import net.daporkchop.lib.primitive.map.tree.DoubleLongTreeMap;
 ...
 * @author DaPorkchop_
 */
public class DoubleLongIndexedTreeMap extends DoubleLongTreeMap    {
    protected boolean[] index;

    public DoubleLongIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleLongIndexedTreeMap this_ = DoubleLongIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleLongIterator   {
        ...
        public DoubleLongTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleLongImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
