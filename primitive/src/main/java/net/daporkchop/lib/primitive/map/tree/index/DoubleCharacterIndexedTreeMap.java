...
import net.daporkchop.lib.primitive.map.tree.DoubleCharacterTreeMap;
...
/**
 * A tree map, using a key type of double and a value type of char.
 ...
 * @author DaPorkchop_
 */
public class DoubleCharacterIndexedTreeMap extends DoubleCharacterTreeMap    {
    protected boolean[] index;

    public DoubleCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements DoubleIterator   {
        ...
        private final DoubleCharacterIndexedTreeMap this_ = DoubleCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements DoubleCharacterIterator   {
        ...
        public DoubleCharacterTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new DoubleCharacterImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
