...
public class SerpentHelper extends BlockCipherHelper<SerpentKey> {
    public SerpentHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull SerpentKey key) {
        this(mode, scheme, key, UpdaterMode.HASH_SHA_256);
    }

    public SerpentHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull SerpentKey key, @NonNull UpdaterMode updater) {
