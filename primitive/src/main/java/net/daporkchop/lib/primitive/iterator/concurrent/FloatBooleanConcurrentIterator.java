...
import net.daporkchop.lib.primitive.lambda.function.bi.FloatBooleanToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of float => boolean mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface FloatBooleanConcurrentIterator extends FloatBooleanIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull FloatBooleanToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                FloatBooleanTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<FloatBooleanTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<FloatBooleanTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull FloatBooleanConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<FloatBooleanTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull FloatBooleanToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
