...
import net.daporkchop.lib.primitive.map.tree.IntegerByteTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of byte.
 ...
 * @author DaPorkchop_
 */
public class IntegerByteIndexedTreeMap extends IntegerByteTreeMap    {
    protected boolean[] index;

    public IntegerByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerByteIndexedTreeMap this_ = IntegerByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerByteIterator   {
        ...
        public IntegerByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
