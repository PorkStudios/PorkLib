...
import net.daporkchop.lib.primitive.map.tree.CharacterShortTreeMap;
...
/**
 * A tree map, using a key type of char and a value type of short.
 ...
 * @author DaPorkchop_
 */
public class CharacterShortIndexedTreeMap extends CharacterShortTreeMap    {
    protected boolean[] index;

    public CharacterShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterShortIndexedTreeMap this_ = CharacterShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterShortIterator   {
        ...
        public CharacterShortTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterShortImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
