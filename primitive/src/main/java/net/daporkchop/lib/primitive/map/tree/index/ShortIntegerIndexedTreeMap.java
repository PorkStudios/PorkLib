...
import net.daporkchop.lib.primitive.map.tree.ShortIntegerTreeMap;
 ...
 * @author DaPorkchop_
 */
public class ShortIntegerIndexedTreeMap extends ShortIntegerTreeMap    {
    protected boolean[] index;

    public ShortIntegerIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortIntegerIndexedTreeMap this_ = ShortIntegerIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortIntegerIterator   {
        ...
        public ShortIntegerTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortIntegerImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
