...
import net.daporkchop.lib.primitive.lambda.function.ObjectToDoubleFunction;
...
/**
 * A map, using a key type of K and a value type of double.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface ObjectDoubleMap<K extends Object>   {
    /**
     ...
     */
    default void putAll(@NonNull K[] keys, @NonNull double[] values)    {
     ...
     */
    default void putAll(@NonNull ObjectDoubleMap<K> map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(ObjectDoubleConsumer<K> consumer);
     ...
     */
    ObjectDoubleIterator entryIterator();
     ...
     */
    default double getOrDefault(K key, double def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default double computeIfAbsent(K key, @NonNull ObjectToDoubleFunction<K> func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
