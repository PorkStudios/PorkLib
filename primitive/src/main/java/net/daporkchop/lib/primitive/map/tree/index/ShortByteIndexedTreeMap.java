...
import net.daporkchop.lib.primitive.map.tree.ShortByteTreeMap;
...
/**
 * A tree map, using a key type of short and a value type of byte.
 ...
 * @author DaPorkchop_
 */
public class ShortByteIndexedTreeMap extends ShortByteTreeMap    {
    protected boolean[] index;

    public ShortByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ShortIterator   {
        ...
        private final ShortByteIndexedTreeMap this_ = ShortByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements ShortByteIterator   {
        ...
        public ShortByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ShortByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
