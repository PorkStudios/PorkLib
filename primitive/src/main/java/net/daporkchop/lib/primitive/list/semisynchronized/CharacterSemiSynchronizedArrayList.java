 ...
 * @author DaPorkchop_
 */
public class CharacterSemiSynchronizedArrayList implements CharacterList   {
    private int size = 0, len;

    private char[] backing;

    public CharacterSemiSynchronizedArrayList()  {
        this.clear();
    }
    ...
    private class Iterator implements CharacterIterator  {
        private final CharacterSemiSynchronizedArrayList this_ = CharacterSemiSynchronizedArrayList.this;
        private int index;
