...
import net.daporkchop.lib.primitive.map.tree.ObjectCharacterTreeMap;
...
/**
 * A tree map, using a key type of K and a value type of char.
 ...
 * @author DaPorkchop_
 */
public class ObjectCharacterIndexedTreeMap<K extends Object> extends ObjectCharacterTreeMap<K>    {
    protected boolean[] index;

    public ObjectCharacterIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ObjectIterator<K>   {
        ...
        private final ObjectCharacterIndexedTreeMap this_ = ObjectCharacterIndexedTreeMap.this;
    ...
    private class EntryIterator implements ObjectCharacterIterator<K>   {
        ...
        public ObjectCharacterTuple<K> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ObjectCharacterImmutableTuple<K>( (K) this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
