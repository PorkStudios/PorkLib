...
/**
 * A synchronized map, using a key type of short and a value type of byte.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ShortByteMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ShortByteSynchronizedMap implements ShortByteMap    {
    private final Object sync;
    private final ShortByteMap map;

    public ShortByteSynchronizedMap(ShortByteMap map)    {
        this(map, map);
    }

    public ShortByteSynchronizedMap(@NonNull ShortByteMap map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
