...
import net.daporkchop.lib.primitive.lambda.function.LongToDoubleFunction;
...
/**
 * A map, using a key type of long and a value type of double.
 * <p>
...
public interface LongDoubleMap   {
     ...
     */
    default void putAll(@NonNull long[] keys, @NonNull double[] values)    {
     ...
     */
    default void putAll(@NonNull LongDoubleMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(LongDoubleConsumer consumer);
     ...
     */
    LongDoubleIterator entryIterator();
     ...
     */
    default double computeIfAbsent(long key, @NonNull LongToDoubleFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
