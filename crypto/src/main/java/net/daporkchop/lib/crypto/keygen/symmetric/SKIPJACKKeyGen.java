...
public class SKIPJACKKeyGen {
    static {
        BouncyCastleInit.loadClass();
    }

    public static SKIPJACKKey gen(byte[] data) {
        byte[] b = new byte[10];
        int i = 0;
        do {
        ...
        data = b;
        return new SKIPJACKKey(new SecretKeySpec(data, "aaa"), KeyRandom.getBytes(BlockCipherType.SKIPJACK.blockSize));
    }

    public static SKIPJACKKey gen() {
