...
/**
 * A concurrent iterator over an array of char.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class CharacterConcurrentArrayIterator implements CharacterConcurrentIterator  {
    private final char[] arr;
    private final AtomicInteger index = new AtomicInteger(0);
    private final ThreadLocal<AtomicInteger> tlIndex = ThreadLocal.withInitial(() -> new AtomicInteger(-1));

    public CharacterConcurrentArrayIterator(@NonNull char[] arr)    {
        this.arr = arr;
    }
