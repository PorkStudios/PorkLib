...
/**
 * An array list of type double.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class DoubleSemiSynchronizedArrayList implements DoubleList   {
    private int size = 0, len;

    private double[] backing;

    public DoubleSemiSynchronizedArrayList()  {
        this.clear();
    }
    ...
    public boolean removeAt(int index) {
        ...
        synchronized (this) {
            ...
            this.backing[this.backing.length - 1] = 0D; //reset final element
    ...
    @Override
    public void forEach(@NonNull DoubleConsumer consumer)  {
        for (int i = 0; i < this.size; i++) {
    ...
    private class Iterator implements DoubleIterator  {
        private final DoubleSemiSynchronizedArrayList this_ = DoubleSemiSynchronizedArrayList.this;
        private int index;
