...
/**
 * A map, using a key type of boolean and a value type of long.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface BooleanLongMap   {
    /**
     ...
     */
    default void putAll(@NonNull boolean[] keys, @NonNull long[] values)    {
     ...
     */
    default void putAll(@NonNull BooleanLongMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(BooleanLongConsumer consumer);
     ...
     */
    BooleanLongIterator entryIterator();
     ...
     */
    default long putIfAbsent(boolean key, long value)  {
     ...
     */
    default long getOrDefault(boolean key, long def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default long computeIfAbsent(boolean key, @NonNull BooleanToLongFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
