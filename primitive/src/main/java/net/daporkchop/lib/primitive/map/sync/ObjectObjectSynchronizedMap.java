...
/**
 * A synchronized map, using a key type of K and a value type of V.
 * This doesn't do anything by itself, it just serves as a wrapper for another instance of ObjectObjectMap.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class ObjectObjectSynchronizedMap<K extends Object, V extends Object> implements ObjectObjectMap<K, V>    {
    private final Object sync;
    private final ObjectObjectMap<K, V> map;

    public ObjectObjectSynchronizedMap(ObjectObjectMap<K, V> map)    {
        this(map, map);
    }

    public ObjectObjectSynchronizedMap(@NonNull ObjectObjectMap<K, V> map, @NonNull Object sync)    {
        this.sync = sync;
        this.map = map;
    }
