...
/**
 * A tree map, using a key type of boolean and a value type of boolean.
 ...
 * Although this map WORKS, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.BooleanBooleanIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class BooleanBooleanTreeMap implements BooleanBooleanMap    {
    ...
    @SuppressWarnings("unchecked")
    protected boolean remove(boolean key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return false; //no mapping
    ...
    public BooleanIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.BooleanBooleanIndexedTreeMap} for an implementation of this method
        return null;
    }
