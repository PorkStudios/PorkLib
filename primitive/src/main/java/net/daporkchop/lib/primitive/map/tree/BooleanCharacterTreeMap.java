 ...
 * Although this map 𝙒𝙊𝙍𝙆𝙎, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.BooleanCharacterIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class BooleanCharacterTreeMap implements BooleanCharacterMap    {
    ...
    public BooleanCharacterTreeMap()    {
        this.clear();
    }
    ...
    @SuppressWarnings("unchecked")
    protected char remove(boolean key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return (char) 0; //no mapping
    ...
    public BooleanIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.BooleanCharacterIndexedTreeMap} for an implementation of this method
        return null;
    }
