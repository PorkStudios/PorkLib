 ...
 * overhead, and can even be made concurrent with little extra work (see {@link net.daporkchop.lib.primitive.map.concurrent.DoubleIntegerConcurrentTreeHashMap})
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public class DoubleIntegerTreeHashMap implements DoubleIntegerMap    {
    ...
    public DoubleIntegerTreeHashMap()    {
        this(null, 0);
    }

    public DoubleIntegerTreeHashMap(DoubleToLongFunction hashFunc, int hashLen)    {
        ...
        this.rootPointer = this.hashLen == 0 ? new DoubleIntegerTreeHashMap.ValueSector(null, -1) : new DoubleIntegerTreeHashMap.PointerSector(null, -1);
    }
    ...
    public void forEachKey(@NonNull DoubleConsumer consumer)  {
        ObjectConsumer<Sector> c = sector -> {
                    if (sector instanceof DoubleIntegerTreeHashMap.PointerSector)    {
    ...
    private Sector getSectorFor(long hash, boolean create)    {
        ...
        for (int i = 1; i < this.hashLen; i++) {
            ...
            if (next == null)    {
                if (create) {
                    next = i + 1 == this.hashLen ? new DoubleIntegerTreeHashMap.ValueSector(curr, off) : new DoubleIntegerTreeHashMap.PointerSector(curr, off);
    ...
    private class ValueSector extends Sector   {
        ...
        public int setEntry(int index, double key, int value)   {
            ...
            if (this.states.get(index))    {
                ...
                this.states.set(index);
                this.refs++;
                DoubleIntegerTreeHashMap.this.size.incrementAndGet();
                return 0;
            }
        }
        ...
        public int removeEntry(int index)  {
            if (this.states.get(index)) {
                this.states.clear(index);
                DoubleIntegerTreeHashMap.this.size.decrementAndGet();
                if (--this.refs == 0 && this.parent != null)   {
                    this.parent.removeSector(this.parentOffset);
                }
                return this.values[index];
