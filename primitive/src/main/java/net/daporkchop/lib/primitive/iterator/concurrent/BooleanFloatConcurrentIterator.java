...
import net.daporkchop.lib.primitive.lambda.function.bi.BooleanFloatToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of boolean => float mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface BooleanFloatConcurrentIterator extends BooleanFloatIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull BooleanFloatToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                BooleanFloatTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<BooleanFloatTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<BooleanFloatTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull BooleanFloatConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<BooleanFloatTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull BooleanFloatToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
