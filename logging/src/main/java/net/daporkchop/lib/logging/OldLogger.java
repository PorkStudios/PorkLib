...
public class OldLogger implements Logging {
     ...
     */
    public static final OldLogger DEFAULT_LOG = builder().level(1).build();
     ...
     * <p>
     * If {@code null}, the date prefix will be omitted, even if {@link OldLogger#prefixOrder} would add a date.
     */
    @lombok.Builder.Default
     ...
     * <p>
     * If {@code null}, the log level prefix will be omitted, even if {@link OldLogger#prefixOrder} would add a log level.
     */
    @lombok.Builder.Default
