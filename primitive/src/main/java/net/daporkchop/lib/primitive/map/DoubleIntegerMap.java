...
/**
 * A map, using a key type of double and a value type of int.
 * <p>
...
public interface DoubleIntegerMap   {
     ...
     */
    default void putAll(@NonNull double[] keys, @NonNull int[] values)    {
     ...
     */
    default void putAll(@NonNull DoubleIntegerMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(DoubleIntegerConsumer consumer);
     ...
     */
    DoubleIntegerIterator entryIterator();
     ...
     */
    default int computeIfAbsent(double key, @NonNull DoubleToIntegerFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
