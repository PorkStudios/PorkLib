...
public class TwoFishHelper extends BlockCipherHelper<TwoFishKey> {
    public TwoFishHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull TwoFishKey key) {
        this(mode, scheme, key, UpdaterMode.HASH_SHA_256);
    }

    public TwoFishHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull TwoFishKey key, @NonNull UpdaterMode updater) {
