...
import net.daporkchop.lib.primitive.map.tree.ObjectShortTreeMap;
...
/**
 * A tree map, using a key type of K and a value type of short.
 ...
 * @author DaPorkchop_
 */
public class ObjectShortIndexedTreeMap<K extends Object> extends ObjectShortTreeMap<K>    {
    protected boolean[] index;

    public ObjectShortIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements ObjectIterator<K>   {
        ...
        private final ObjectShortIndexedTreeMap this_ = ObjectShortIndexedTreeMap.this;
    ...
    private class EntryIterator implements ObjectShortIterator<K>   {
        ...
        public ObjectShortTuple<K> advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new ObjectShortImmutableTuple<K>( (K) this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
