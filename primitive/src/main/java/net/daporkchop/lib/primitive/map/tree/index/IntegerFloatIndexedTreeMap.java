...
import net.daporkchop.lib.primitive.map.tree.IntegerFloatTreeMap;
...
/**
 * A tree map, using a key type of int and a value type of float.
 ...
 * @author DaPorkchop_
 */
public class IntegerFloatIndexedTreeMap extends IntegerFloatTreeMap    {
    protected boolean[] index;

    public IntegerFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements IntegerIterator   {
        ...
        private final IntegerFloatIndexedTreeMap this_ = IntegerFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements IntegerFloatIterator   {
        ...
        public IntegerFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new IntegerFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
