...
import net.daporkchop.lib.primitive.lambda.function.bi.CharacterBooleanToBooleanFunction;
...
/**
 * Allows parallel iteration over an iterator of char => boolean mappings. Implementing classes should be
 ...
 * @author DaPorkchop_
 */
public interface CharacterBooleanConcurrentIterator extends CharacterBooleanIterator   {
    /**
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull CharacterBooleanToBooleanFunction function)    {
        try {
            while (this.hasNext())  {
                CharacterBooleanTuple tuple = this.advance();
     ...
     *                 false otherwise.
     */
    default void concurrentIterate(@NonNull ObjectToBooleanFunction<CharacterBooleanTuple> function)    {
        try {
            while (this.hasNext())  {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectConsumer<CharacterBooleanTuple> consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull CharacterBooleanConsumer consumer)    {
    ...
    @Override
    default void forEachRemaining(@NonNull ObjectToBooleanFunction<CharacterBooleanTuple> function)    {
        this.concurrentIterate(function);
    }

    @Override
    default void forEachRemaining(@NonNull CharacterBooleanToBooleanFunction function)    {
        this.concurrentIterate(function);
    }
}
