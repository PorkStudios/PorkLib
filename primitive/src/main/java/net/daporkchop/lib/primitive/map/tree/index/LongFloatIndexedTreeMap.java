...
import net.daporkchop.lib.primitive.map.tree.LongFloatTreeMap;
 ...
 * @author DaPorkchop_
 */
public class LongFloatIndexedTreeMap extends LongFloatTreeMap    {
    protected boolean[] index;

    public LongFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements LongIterator   {
        ...
        private final LongFloatIndexedTreeMap this_ = LongFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements LongFloatIterator   {
        ...
        public LongFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new LongFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
