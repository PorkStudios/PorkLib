...
import net.daporkchop.lib.primitive.map.tree.CharacterByteTreeMap;
...
/**
 * A tree map, using a key type of char and a value type of byte.
 ...
 * @author DaPorkchop_
 */
public class CharacterByteIndexedTreeMap extends CharacterByteTreeMap    {
    protected boolean[] index;

    public CharacterByteIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements CharacterIterator   {
        ...
        private final CharacterByteIndexedTreeMap this_ = CharacterByteIndexedTreeMap.this;
    ...
    private class EntryIterator implements CharacterByteIterator   {
        ...
        public CharacterByteTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new CharacterByteImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
