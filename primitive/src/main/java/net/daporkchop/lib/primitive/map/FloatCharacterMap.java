...
import net.daporkchop.lib.primitive.lambda.function.FloatToCharacterFunction;
...
/**
 * A map, using a key type of float and a value type of char.
 * <p>
 * DO NOT EDIT BY HAND! THIS FILE IS SCRIPT-GENERATED!
 *
 * @author DaPorkchop_
 */
public interface FloatCharacterMap   {
    /**
     ...
     */
    default void putAll(@NonNull float[] keys, @NonNull char[] values)    {
     ...
     */
    default void putAll(@NonNull FloatCharacterMap map)    {
     ...
     * @param consumer the function to run
     */
    void forEachEntry(FloatCharacterConsumer consumer);
     ...
     */
    FloatCharacterIterator entryIterator();
     ...
     */
    default char getOrDefault(float key, char def)   {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
            this.put(key, def);
     ...
     */
    default char computeIfAbsent(float key, @NonNull FloatToCharacterFunction func) {
        if (this.containsKey(key))  {
            return this.get(key);
        } else {
