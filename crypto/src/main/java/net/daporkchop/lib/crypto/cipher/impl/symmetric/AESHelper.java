...
public class AESHelper extends BlockCipherHelper<AESKey> {
    public AESHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull AESKey key) {
        this(mode, scheme, key, UpdaterMode.HASH_SHA_256);
    }

    public AESHelper(@NonNull BlockCipherMode mode, @NonNull PaddingScheme scheme, @NonNull AESKey key, @NonNull UpdaterMode updater) {
