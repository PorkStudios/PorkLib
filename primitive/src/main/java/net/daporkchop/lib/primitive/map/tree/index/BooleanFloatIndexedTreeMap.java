...
import net.daporkchop.lib.primitive.map.tree.BooleanFloatTreeMap;
 ...
 * @author DaPorkchop_
 */
public class BooleanFloatIndexedTreeMap extends BooleanFloatTreeMap    {
    protected boolean[] index;

    public BooleanFloatIndexedTreeMap()    {
        super();
    }
    ...
    private class KeyIterator implements BooleanIterator   {
        ...
        private final BooleanFloatIndexedTreeMap this_ = BooleanFloatIndexedTreeMap.this;
    ...
    private class EntryIterator implements BooleanFloatIterator   {
        ...
        public BooleanFloatTuple advance()   {
            if (this.hasNext()) {
                this.findNext();
                return this.tuple = new BooleanFloatImmutableTuple( this_.keys[this.index],  this_.values[this.index]);
            } else {
                throw new ArrayIndexOutOfBoundsException();
            }
        }
