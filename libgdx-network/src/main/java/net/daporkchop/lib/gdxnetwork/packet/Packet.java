...
public interface Packet {
     ...
     */
    void encode(@NonNull DataOut out);

    int getId();

    /**
     * Gets the length (in bytes) of the packet's current data. If < 0, a normal byte array ouput stream
     * will be used (slower!)
     *
