 ...
 * @author DaPorkchop_
 */
public class BooleanSemiSynchronizedArrayList implements BooleanList   {
    private int size = 0, len;

    private boolean[] backing;

    public BooleanSemiSynchronizedArrayList()  {
        this.clear();
    }
    ...
    private class Iterator implements BooleanIterator  {
        private final BooleanSemiSynchronizedArrayList this_ = BooleanSemiSynchronizedArrayList.this;
        private int index;
