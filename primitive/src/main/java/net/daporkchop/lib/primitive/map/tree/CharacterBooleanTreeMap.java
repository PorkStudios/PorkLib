...
/**
 * A tree map, using a key type of char and a value type of boolean.
 ...
 * Although this map WORKS, it's not really particularly optimized. I'd advise using {@link net.daporkchop.lib.primitive.map.tree.index.CharacterBooleanIndexedTreeMap},
 ...
 * @author DaPorkchop_
 */
public class CharacterBooleanTreeMap implements CharacterBooleanMap    {
    protected char[] keys;
    ...
    public CharacterBooleanTreeMap()    {
        this.clear();
    }
    ...
    @SuppressWarnings("unchecked")
    protected boolean remove(char key, boolean shrink) {
        int hash = hashKey(key);
        if (!containsKeyHash(hash)) return false; //no mapping
    ...
    public CharacterIterator keyIterator()   {
        //see {@link net.daporkchop.lib.primitive.map.tree.index.CharacterBooleanIndexedTreeMap} for an implementation of this method
        return null;
    }
